        ...
        implements ContextClassProvider
{
     ...
     * classes value
     */
    private static final Class<?>[] CLASSES = new Class<?>[] { Instrument.class,ReportBaseImpl.class,FIXMessageWrapper.class, DeleteSuggestionAction.class, RefreshSuggestionAction.class };
}
