        ...
        implements ContextClassProvider
{
     ...
     * classes value
     */
    private static final Class<?>[] CLASSES = new Class<?>[] { Instrument.class,ReportBaseImpl.class,FIXMessageWrapper.class, OrderSingleSuggestionImpl.class, RefreshSuggestionAction.class };
}
