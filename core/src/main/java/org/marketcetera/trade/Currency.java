        ...
        implements Comparable<Currency>
{
     ...
     * @param baseCCY a <code>String</code> value
     * @param plCCY a <code>String</code> value
     * @param nearTenor a <code>LocalDate</code> value
     */
     ...
     * @param plCCY a <code>String</code> value
     * @param nearTenor a <code>String</code> value
     * @param farTenor a <code>LocalDate</code> value
     */
     ...
     * 
     * @param leftCCY a <code>String</code> value
     * @param rightCCY a <code>String</code> value
     * @param nearTenor a <code>String</code> value
     ...
     *  
     * @param ccy a <code>String</code> value
     */
     ...
     * @param tenor a <code>String</code> value
     * @return a <code>boolean</code> value
     */
