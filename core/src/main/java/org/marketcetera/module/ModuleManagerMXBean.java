 ...
 *       <li>Parameter Value:<code>"metc:surface:color:red,http://red.com,username,12.43"</code></li>
 *     </ul>
 *   </li>
 *   <li>Example 2:
 *     <ul>
 ...
 *           a strategy module 'buy' that accepts a string parameter '12^32^43'.</li> 
 *     </ul>
 *   </li>
 * </ul>
 *
