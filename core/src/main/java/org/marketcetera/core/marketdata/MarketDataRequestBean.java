    ...
    public String toString()
    {
        ...
        if(symbols != null &&
           !symbols.isEmpty()) {
            ...
            output.append(MarketDataRequestBuilder.SYMBOLS_KEY).append(KEY_VALUE_SEPARATOR);
            for(String symbol : symbols) {
                if(symbolListDelimiterNeeded) {
                    output.append(MarketDataRequestBuilder.SYMBOL_DELIMITER);
                }
        ...
        if(underlyingSymbols != null &&
           !underlyingSymbols.isEmpty()) {
            boolean symbolListDelimiterNeeded = false;
            output.append(MarketDataRequestBuilder.UNDERLYINGSYMBOLS_KEY).append(KEY_VALUE_SEPARATOR);
        ...
        if(provider != null) {
            ...
            output.append(MarketDataRequestBuilder.PROVIDER_KEY).append(KEY_VALUE_SEPARATOR).append(String.valueOf(provider));
            delimiterNeeded = true;
        }
        ...
        if(!content.isEmpty()) {
            ...
            output.append(MarketDataRequestBuilder.CONTENT_KEY).append(KEY_VALUE_SEPARATOR).append(content.toString().replaceAll("[\\[\\] ]", //$NON-NLS-1$
                                                                                                        "")); //$NON-NLS-1$
            delimiterNeeded = true;
        }
        ...
        if(exchange != null) {
            ...
            output.append(MarketDataRequestBuilder.EXCHANGE_KEY).append(KEY_VALUE_SEPARATOR).append(String.valueOf(exchange));
            delimiterNeeded = true;
        }
        ...
        if(assetClass != null) {
            ...
            output.append(MarketDataRequestBuilder.ASSETCLASS_KEY).append(KEY_VALUE_SEPARATOR).append(String.valueOf(assetClass));
            delimiterNeeded = true;
        }
        ...
        if(!parameters.isEmpty()) {
            ...
            output.append(MarketDataRequestBuilder.PARAMETERS_KEY).append(KEY_VALUE_SEPARATOR);
