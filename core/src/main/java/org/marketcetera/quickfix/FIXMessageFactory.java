...
public class FIXMessageFactory {
                                                 ...
                                                 DateTime inDateTime)
    {
        ...
        inGroup.setField(new quickfix.field.MDEntryDate(DateService.toLocalDate(inDateTime.minusMillis(inDateTime.getMillisOfDay()).toDate())));
        inGroup.setField(new quickfix.field.MDEntryTime(DateService.toLocalTime(inDateTime.minusYears(inDateTime.getYear()).minusDays(inDateTime.getDayOfYear()).toDate())));
    }
    /**
