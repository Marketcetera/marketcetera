        ...
        implements QuoteEvent, HasEventBean
{
    ...
    {
        quote.setRequestId(inRequestId);
    }
    /* (non-Javadoc)
    ...
    public final String toString()
    {
        ...
        output.append(" ").append(getExchange()).append(" at ").append(getExchangeTimestamp()); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        if(getLevel() != 0) {
            output.append(" level").append(getLevel()).append(": ").append(getCount());
        }
