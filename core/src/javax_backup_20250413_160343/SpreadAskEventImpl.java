...
/**
 * Provides a spread implementation of {@link AskEvent}.
 *
 * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
 * @version $Id$
 * @since $Release$
 */
public class SpreadAskEventImpl
        extends AbstractQuoteEventImpl
        implements AskEvent,SpreadEvent
{
    /* (non-Javadoc)
     ...
     */
    private static final String description = "Spread Ask"; //$NON-NLS-1$
    /**
     * spread attributes 
     */
    @XmlElement
