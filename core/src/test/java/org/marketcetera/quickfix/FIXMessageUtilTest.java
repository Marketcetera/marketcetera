...
/*/
    ...
    public void testExceptionsInMergeMarketDataMessages() throws Exception {
        ...
        new ExpectedFailure<IllegalArgumentException>(Messages.FIX_MD_MERGE_INVALID_INCOMING_SNAPSHOT.getText()) {
            @Override
            protected void run()
                    throws Exception
            {
        ...
        new ExpectedFailure<IllegalArgumentException>(Messages.FIX_MD_MERGE_INVALID_INCOMING_INCREMENTAL.getText()) {
            @Override
            protected void run()
                    throws Exception
            {
