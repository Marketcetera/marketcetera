package org.marketcetera.marketdata.neo.provider;
...
import org.marketcetera.marketdata.neo.manager.MarketDataProviderNotAvailable;
import org.marketcetera.marketdata.neo.manager.MarketDataRequestFailed;
import org.marketcetera.marketdata.neo.request.MarketDataRequest;
import org.marketcetera.marketdata.neo.request.MarketDataRequestAtom;
import org.marketcetera.marketdata.neo.request.MarketDataRequestBuilder;
import org.marketcetera.marketdata.neo.request.MarketDataRequestToken;
import org.marketcetera.marketdata.neo.request.impl.MarketDataRequestBuilderImpl;
...
public class AbstractMarketDataProviderTest
{
    ...
    /**
     * Tests {@link AbstractMarketDataProvider#requestMarketData(org.marketcetera.marketdata.neo.request.MarketDataRequestToken)}.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
            ...
            throws Exception
    {
        ...
        provider.requestMarketData(generateRequestToken(generateRequest(new String[] { "METC" },
        ...
        new ExpectedFailure<MarketDataRequestFailed>(Messages.UNSUPPORTED_MARKETDATA_CONTENT,
            ...
            protected void run()
                    throws Exception
            {
                provider.requestMarketData(generateRequestToken(generateRequest(new String[] { "AAPL" },
                                                                                EnumSet.of(Content.TOP_OF_BOOK))));
            }
        };
        assertTrue(provider.getRequestedAtoms().isEmpty());
        ...
        final MarketDataRequest multiContentRequest = generateRequest(new String[] { "YHOO" },
