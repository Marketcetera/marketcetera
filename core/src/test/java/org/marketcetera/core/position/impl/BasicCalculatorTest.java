...
public class BasicCalculatorTest {
    ...
    public void test() {
        BasicCalculator pnl = new BasicCalculator(BigDecimal.ZERO,
                BigDecimal.ZERO);
        assertPNL(pnl.trade(createTrade("100", "21")), "100", null, null, "0",
                null, null);
        assertPNL(pnl.tick("21"), "100", "0", "0", "0", "0", "0");
        assertPNL(pnl.trade(createTrade("-50", "21.08")), "50", "0", "4", "4",
                "0", "4");
        assertPNL(pnl.tick("21.08"), "50", "0", "8", "4", "4", "8");
        assertPNL(pnl.trade(createTrade("100", "21.12")), "150", "0", "4", "4",
                "0", "4");
        assertPNL(pnl.tick("21.12"), "150", "0", "10", "4", "6", "10");
        assertPNL(pnl.trade(createTrade("-100", "21.20")), "50", "0", "18",
                "18", "0", "18");
    ...
    public void shortTest() {
        BasicCalculator pnl = new BasicCalculator(BigDecimal.ZERO,
                BigDecimal.ZERO);
        assertPNL(pnl.trade(createTrade("-100", "21")), "-100", null, null,
                "0", null, null);
    ...
    public void shortTest2() {
        ...
        assertPNL(pnl.trade(createTrade("-100", "21")), "-100", "0", "-100",
                "0", "-100", "-100");
    }
    ...
    public void shortTest3() {
        ...
        assertPNL(pnl.trade(createTrade("-100", "21")), "-100", "0", "-100",
                "0", "-100", "-100");
        assertPNL(pnl.trade(createTrade("100", "20")), "0", "0", "100", "100",
                "0", "100");
    }

    @Test
    public void incomingPosition() {
        BasicCalculator pnl = new BasicCalculator(new BigDecimal("10"),
                new BigDecimal("15"));
        assertPNL(pnl.tick("16"), "10", "10", "0", "0", "10", "10");
        assertPNL(pnl.trade(createTrade("10", "16")), "20", "10", "0", "0",
                "10", "10");
        assertPNL(pnl.tick("17"), "20", "20", "10", "0", "30", "30");
        assertPNL(pnl.trade(createTrade("-15", "17")), "5", "20", "10", "25",
                "5", "30");
    }
    ...
    private void assertPNL(PositionMetrics pnl, String position,
            String positional, String trading, String realized,
            String unrealized, String total) {
