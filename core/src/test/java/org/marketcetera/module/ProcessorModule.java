...
public class ProcessorModule extends ModuleBase
    ...
    private Hashtable<RequestID,Pair<Class<?>,DataEmitterSupport>> mTable = new Hashtable<RequestID,Pair<Class<?>,DataEmitterSupport>>();
    private HashSet<DataFlowID> mFlows = new HashSet<>();
}
