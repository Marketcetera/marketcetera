 ...
 * @since 0.5.0
 * @version $Id: TSLF4JLoggerProxyTest.java 16063 2012-01-31 18:21:55Z colin $
 */
    ...
    extends TestCaseBase
{
    ...
    public void categories()
    {
        ...
        setLevel(TEST_CATEGORY,
                 Level.ERROR);
        assertNoEvents();
        SLF4JLoggerProxy.error(null,
                               TEST_MESSAGE);
        assertSingleEvent(Level.ERROR,
                          SLF4JLoggerProxy.UNKNOWN_LOGGER_NAME,
                          TEST_MESSAGE,
                          TEST_LOCATION);
        SLF4JLoggerProxy.error(TEST_CATEGORY,
                               TEST_MESSAGE);
        assertSingleEvent(Level.ERROR,
                          TEST_CATEGORY,
                          TEST_MESSAGE,
                          TEST_LOCATION);
        SLF4JLoggerProxy.error(getClass(),
                               TEST_MESSAGE);
        assertSingleEvent(Level.ERROR,
                          getClass().getName(),
                          TEST_MESSAGE,TEST_LOCATION);
