...
import org.marketcetera.core.event.MockAggregateEvent;
import org.marketcetera.core.event.MockEvent;
    ...
    extends MarketDataFeedTestBase
{
    ...
    /**
     * Verifies that {@link org.marketcetera.core.event.AggregateEvent} objects are properly decomposed.
     *
     * @throws Exception if an error occurs
     */
    @Test
        ...
        throws Exception
    {
        ...
        List<QuoteEvent> expectedEvents = Arrays.asList(new QuoteEvent[] { EventTestBase.generateEquityAskEvent(metc, exchange),
