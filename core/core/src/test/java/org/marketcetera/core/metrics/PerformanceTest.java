...
/* $License$ */
/**
 * Computes the performance impact of {@link org.marketcetera.core.metrics.ThreadedMetric}.
 * <p>
...
public class PerformanceTest {
    ...
    private static final Callable<Boolean> SAMPLING_CONDITION =
            ConditionsFactory.createSamplingCondition(SAMPLING_INTERVAL, "doesnotmatter");
}
