 ...
 * @since 2.0.0
 * @version $Id: FIXConverterTest.java 16063 2012-01-31 18:21:55Z colin $
 */
    ...
    extends TypesTestBase
{
    ...
    /**
     * Sets all the fields of an {@link org.marketcetera.core.trade.OrderBase}, and its FIX
    ...
    {
        if (orderID) {
            o.setOrderID(new org.marketcetera.core.trade.OrderID("1"));
            msg.setField
        ...
        if (side) {
            ...
            msg.setField
                (new quickfix.field.Side
                 (org.marketcetera.core.trade.Side.Buy.getFIXValue()));
        }
        if (quantity) {
         ...
         boolean price)
    {
        ...
        if (timeInForce) {
            o.setTimeInForce(org.marketcetera.core.trade.TimeInForce.Day);
            msg.setField
                (new quickfix.field.TimeInForce
                 (org.marketcetera.core.trade.TimeInForce.Day.getFIXValue()));
        }
        if (positionEffect) {
            o.setPositionEffect(org.marketcetera.core.trade.PositionEffect.Open);
            msg.setField
                (new quickfix.field.PositionEffect
                 (org.marketcetera.core.trade.PositionEffect.Open.getFIXValue()));
        }
        if (orderCapacity) {
            o.setOrderCapacity(org.marketcetera.core.trade.OrderCapacity.Individual);
            msg.setField
                (new quickfix.field.OrderCapacity
                 (org.marketcetera.core.trade.OrderCapacity.Individual.getFIXValue()));
        }
        if (price) {
    ...
    /**
     * Sets all the fields of a {@link org.marketcetera.core.trade.RelatedOrder}, and its FIX
     * representation, to known test values.
     */
    ...
    {
        if (originalOrderID) {
            o.setOriginalOrderID(new org.marketcetera.core.trade.OrderID("2"));
            msg.setField
