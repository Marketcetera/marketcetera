...
public final class EventServices
{
     ...
     * specifically, implementers of {@link org.marketcetera.core.event.beans.HasEventBean}.  If successful,
     * the two objects are compared according to the contract specified
     * in {@link org.marketcetera.core.event.Event} for event implementers.  If unsuccessful, that is,
     * if either of the objects does not implement {@link org.marketcetera.core.event.beans.HasEventBean},
