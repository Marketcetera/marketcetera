...
public interface Messages {
    ...
    static final I18NMessage1P CONVERTIBLE_BONDS_NOT_SUPPORTED_FOR_FIX_VERSION = new I18NMessage1P(LOGGER,
                                                                                                   "convertible_bonds_not_supported_for_fix_version");   //$NON-NLS-1$
