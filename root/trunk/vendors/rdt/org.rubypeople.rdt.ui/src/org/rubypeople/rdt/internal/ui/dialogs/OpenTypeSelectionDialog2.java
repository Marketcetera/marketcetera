...
public class OpenTypeSelectionDialog2 extends TypeSelectionDialog2 {
	...
	public OpenTypeSelectionDialog2(Shell parent, boolean multi, IRunnableContext context, IRubySearchScope scope, int elementKinds) {
	...
	protected void configureShell(Shell newShell) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(newShell, IRubyHelpContextIds.OPEN_TYPE_DIALOG);
	}
