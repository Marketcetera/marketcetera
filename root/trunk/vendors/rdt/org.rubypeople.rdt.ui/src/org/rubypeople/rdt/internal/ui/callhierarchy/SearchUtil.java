...
import org.rubypeople.rdt.internal.ui.search.LRUWorkingSetsList;
...
public class SearchUtil {
	...
	static void restoreState() {
		...
		SearchUtil.fgSettingsStore= RubyPlugin.getDefault().getDialogSettings().getSection(SearchUtil.DIALOG_SETTINGS_KEY);
		if (SearchUtil.fgSettingsStore == null)
			SearchUtil.fgSettingsStore= RubyPlugin.getDefault().getDialogSettings().addNewSection(SearchUtil.DIALOG_SETTINGS_KEY);
