...
public class OrderFormatterTest extends FIXVersionedTestCase {
	...
	public void testFormat() throws ParseException {
		...
		Message order1 = msgFactory.newMarketOrder("1", Side.BUY, new BigDecimal(100), new Equity("IBM"), TimeInForce.DAY, null);
		assertEquals("B 100 IBM MKT", formatter.format(order1));

		Message order2 = msgFactory.newLimitOrder("1", Side.SELL_SHORT, new BigDecimal(100), new Equity("IBM"), BigDecimal.TEN, TimeInForce.DAY, null);
	...
	public void testOptionFormat() throws ParseException {
		...
		Message order2 = msgFactory.newLimitOrder("1", Side.SELL, new BigDecimal(100), new Equity("IBM"), BigDecimal.TEN, TimeInForce.DAY, null);
