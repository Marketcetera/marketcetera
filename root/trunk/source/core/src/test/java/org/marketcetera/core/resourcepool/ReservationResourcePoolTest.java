...
public class ReservationResourcePoolTest
        extends TestCase
{
    protected ReservationResourcePool mTestPool;
    ...
    public void test1()
        throws Exception
    {
        ExecutableBlock myBlock = new ExecutableBlock() {
            public void execute(Resource inResource)
                    throws Throwable
            {
                System.out.println("Issued resource: " + inResource);
            }
        };
        
        mTestPool.execute(myBlock,
                          mData);
    }
...
////        TestResource newR1 = (TestResource)mTestPool.requestResource(key);
...
////        TestResource r1 = (TestResource)mTestPool.requestResource(mData);
////        mTestPool.dumpReservationTable();
////        mTestPool.dumpResourcePool();
////        assertNotNull(r1);
