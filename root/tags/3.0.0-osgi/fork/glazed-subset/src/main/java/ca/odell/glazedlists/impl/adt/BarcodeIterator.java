...
public class BarcodeIterator implements Iterator {
    ...
    /**
     * Returns whether or not there are more values in the {@link ca.odell.glazedlists.impl.adt.Barcode} to
     * iterate over.
     */
    ...
    /**
     * Returns true if there are more BLACK elements in the {@link ca.odell.glazedlists.impl.adt.Barcode} to
     * move the {@link java.util.Iterator} to.
     */
    ...
    /**
     * Returns true if there are more WHITE elements in the {@link ca.odell.glazedlists.impl.adt.Barcode} to
     * move the {@link java.util.Iterator} to.
     */
    ...
    /**
     * Returns true if there are more elements in the {@link ca.odell.glazedlists.impl.adt.Barcode} to
     * move the {@link java.util.Iterator} to that match the provided colour.
     */
    ...
    /**
     * Moves this {@link java.util.Iterator} to the next element in the {@link ca.odell.glazedlists.impl.adt.Barcode}
     * that is BLACK.
     *
     * @throws java.util.NoSuchElementException if hasNextBlack() returns false.
     */
     ...
     * that is WHITE.
     *
     * @throws java.util.NoSuchElementException if hasNextWhite() returns false.
     */
     ...
     *
     * @throws java.util.NoSuchElementException if hasNextColour(colour) returns false.
     */
    ...
    /**
     * Removes the current value at the Iterator from the {@link ca.odell.glazedlists.impl.adt.Barcode}.
     */
    public void remove() {
