 ...
 * </table>
 *
 * @see ca.odell.glazedlists.GlazedLists#beanConnector(Class)
...
public class ObservableElementList<E> extends TransformedList<E, E> {
     ...
     * {@link java.util.EventListener} associated with the observed element at the same
     * index within {@link #observedElements}.
     */
    private List<EventListener> multiEventListenerRegistry = null;

    /**
     * The single {@link java.util.EventListener} shared by all list elements if a
     ...
     * {@link ca.odell.glazedlists.impl.adt.Barcode#BLACK} indicates the {@link #singleEventListener} has
     * been registered on the element at the index; {@link ca.odell.glazedlists.impl.adt.Barcode#WHITE}
     ...
     *      is attached to
     * @param listener the {@link java.util.EventListener} registered to the observed
    ...
    /**
     * Returns the {@link java.util.EventListener} at the given <code>index</code>.
     *
     * @param index the location of the {@link java.util.EventListener} to be returned
     * @return the {@link java.util.EventListener} at the given <code>index</code>
     */
     ...
     *
     * @param index the index of the {@link java.util.EventListener} to be unregistered
    ...
    /**
     * Releases the resources consumed by this {@link ca.odell.glazedlists.TransformedList} so that
     * it may eventually be garbage collected.
     *
     * In this case of this {@link ca.odell.glazedlists.TransformedList}, it uses the
     ...
     * to call any method on a {@link ca.odell.glazedlists.TransformedList} after it has been disposed.
     */
    public void dispose() {
    ...
    public interface Connector<E> {
         ...
         *      to be used as a parameter to {@link #uninstallListener(Object, java.util.EventListener)}.
         *      <code>null</code> is taken to mean no listener was installed
         *      and thus {@link #uninstallListener(Object, java.util.EventListener)} need
         *      not be called.
         */
