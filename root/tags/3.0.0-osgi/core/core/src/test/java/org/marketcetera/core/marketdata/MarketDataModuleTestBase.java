        ...
        extends ModuleTestBase
{
        ...
        throws Exception
    {
        ...
        new ExpectedFailure<UnsupportedRequestParameterType>(Messages.UNSUPPORTED_REQ_PARM_TYPE,
                                                             getInstanceURN().toString(),
        ...
        new ExpectedFailure<IllegalRequestParameterValue>(Messages.ILLEGAL_REQ_PARM_VALUE,
                                                          getInstanceURN().toString(),
                                                          invalidString) {
            protected void run()
                throws Exception
        ...
        throws Exception
    {
        ...
        JMX.newMXBeanProxy(mMBeanServer,
                           objectName,
                           AbstractMarketDataModuleMXBean.class,
                           true);
    }
