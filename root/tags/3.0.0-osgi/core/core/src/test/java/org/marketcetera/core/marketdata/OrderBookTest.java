...
public class OrderBookTest
{
        ...
        throws Exception
    {
        ...
        verifyBook(symbol,
                   ...
                   book);
        // create an ask
        AskEvent ask1 = EventTestBase.generateEquityAskEvent(symbol, exchange);
        book.process(ask1);
        asks.add(ask1);
        verifyBook(symbol,
                   bids,
    ...
    /**
     * Tests bad values passed to {@link OrderBook#process(org.marketcetera.core.event.QuoteEvent)}.
     *
     * @throws Exception if an error occurs
     */
    @Test
