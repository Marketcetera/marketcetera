...
/**
 * Tests {@link org.marketcetera.core.event.beans.QuoteBean}.
 *
 * @version $Id: QuoteBeanTest.java 82331 2012-04-10 16:29:48Z colin $
 * @since 2.0.0
 */
...
{
    /**
     * Tests {@link org.marketcetera.core.event.beans.MarketDataBean#copy(org.marketcetera.core.event.beans.MarketDataBean)}.
     *
    ...
    /**
     * Tests {@link QuoteBean#getQuoteBeanFromEvent(org.marketcetera.core.event.QuoteEvent, QuoteAction)} and
     * {@link QuoteBean#getQuoteBeanFromEvent(org.marketcetera.core.event.QuoteEvent, java.util.Date, java.math.BigDecimal, QuoteAction).
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
    ...
    /**
     * Tests {@link org.marketcetera.core.event.beans.MarketDataBean#hashCode()} and {@link org.marketcetera.core.event.beans.MarketDataBean#equals(Object)}.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
