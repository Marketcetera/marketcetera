...
/**
 * Tests {@link org.marketcetera.core.event.impl.DepthOfBookEventBuilder} and {@link org.marketcetera.core.event.impl.DepthOfBookEventImpl}.
 *
 * @version $Id: DepthOfBookEventTest.java 82331 2012-04-10 16:29:48Z colin $
 * @since 2.0.0
 */
        ...
        extends AbstractEventBuilderTestBase<DepthOfBookEvent,DepthOfBookEventBuilder>
{
            ...
            throws Exception
    {
        ...
        AskEvent badAsk = EventTestBase.generateOptionAskEvent(option, QuoteAction.ADD);
        newAsks.add(badAsk);
        builder.withAsks(newAsks);
