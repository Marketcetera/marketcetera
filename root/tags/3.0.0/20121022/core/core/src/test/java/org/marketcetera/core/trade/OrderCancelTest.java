...
public class OrderCancelTest extends TypesTestBase {
     ...
     * {@link org.marketcetera.core.trade.Factory#createOrderReplace(org.marketcetera.core.trade.ExecutionReport)}
     *
    ...
    public void pojoDefaults() throws Exception {
        ...
        assertOrderCancel(order, NOT_NULL, new org.marketcetera.core.trade.OrderID(orderID), side,
     ...
     * {@link org.marketcetera.core.trade.Factory#createOrderCancel(org.marketcetera.core.trade.ExecutionReport)}
     *
     * @throws Exception if there were errors
     */
    @Test
    ...
    public void systemFIXWrap() throws Exception {
        ...
        assertOrderBaseValues(order, expectedOrderID, account, text, null,
                qty, side, instrument);
        org.marketcetera.core.trade.OrderID originalOrderID = new org.marketcetera.core.trade.OrderID(origOrderID);
