        ...
        extends AbstractEventBuilderTestBase<TopOfBookEvent,TopOfBookEventBuilder>
{
    ...
    /**
     * Tests {@link TopOfBookEventBuilder#withAsk(org.marketcetera.core.event.AskEvent)}.
     *
    ...
    /**
     * Tests {@link TopOfBookEventBuilder#withBid(org.marketcetera.core.event.BidEvent)}.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
    ...
    /**
     * Tests {@link TopOfBookEventBuilder#withInstrument(org.marketcetera.core.trade.Instrument)}.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
    ...
    /**
     * Tests {@link org.marketcetera.core.event.impl.DepthOfBookEventImpl} validation.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
            ...
            throws Exception
    {
        ...
        AskEvent optionAsk = EventTestBase.generateOptionAskEvent(option, QuoteAction.ADD);
