...
public abstract class CEPTestBase extends ModuleTestBase {
    ...
    public void testCancel() throws Exception {
        ...
        assertEquals("didnt' get bid event", "IBM", theBid.getInstrument());
        ...
        assertEquals("didnt' get bid event", "GOOG", theBid.getInstrument());
        ...
        assertEquals("didnt' get bid event", "IBM", theTrade.getInstrument());
