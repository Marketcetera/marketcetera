...
final class Messages {
    ...
    static I18NMessage0P ORDER_TICKET_VIEW_ACCOUNT__LABEL;
    static I18NMessage0P ORDER_TICKET_VIEW_CUSTOMER_INFO__LABEL;
    ...
    static I18NMessage0P FUTURE_ORDER_TICKET_VIEW_CUSTOMER_INFO__LABEL;
