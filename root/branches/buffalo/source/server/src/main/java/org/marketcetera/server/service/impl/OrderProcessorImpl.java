...
class OrderProcessorImpl
        implements OrderProcessor, Lifecycle
{
    /* (non-Javadoc)
    ...
    public void start()
    {
        SLF4JLoggerProxy.debug(OrderProcessorImpl.class,
                               "Starting order manager");
        if(orderProcessingService.isShutdown() ||
           orderProcessingService.isTerminated()) {
            SLF4JLoggerProxy.error(OrderProcessorImpl.class,
        ...
        public void run()
        {
            ...
            try {
                try {
                    ...
                    SLF4JLoggerProxy.warn(OrderProcessorImpl.class,
                                          e,
