...
/**
 * Image provider for {@link org.rubypeople.rdt.internal.ui.rubyeditor.OverrideIndicatorManager.OverrideIndicator} annotations.
 *
 * @since 3.0
 */
public class OverrideIndicatorImageProvider implements IAnnotationImageProvider {
// TODO Rip out the implements stuff
	/*
	 * @see org.eclipse.ui.texteditor.IAnnotationImageProvider#getManagedImage(org.eclipse.jface.text.source.Annotation)
	 */
	private static final String OVERRIDE_IMG_DESC_ID= "RubyPluginImages.DESC_OBJ_OVERRIDES"; //$NON-NLS-1$
	private static final String OVERWRITE_IMG_DESC_ID= "RubyPluginImages.DESC_OBJ_IMPLEMENTS"; //$NON-NLS-1$
	...
	public ImageDescriptor getImageDescriptor(String imageDescritporId) {
		if (OVERWRITE_IMG_DESC_ID.equals(imageDescritporId))
			return RubyPluginImages.DESC_OBJ_IMPLEMENTS;
		else if (OVERRIDE_IMG_DESC_ID.equals(imageDescritporId))
			return RubyPluginImages.DESC_OBJ_OVERRIDES;
