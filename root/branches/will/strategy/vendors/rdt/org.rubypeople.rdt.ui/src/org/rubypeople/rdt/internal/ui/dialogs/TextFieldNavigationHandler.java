...
import org.rubypeople.rdt.internal.ui.text.RubyWordIterator;
...
public class TextFieldNavigationHandler {
	...
	private static boolean isSubWordNavigationEnabled() {
		IPreferenceStore preferenceStore= RubyPlugin.getDefault().getCombinedPreferenceStore();
