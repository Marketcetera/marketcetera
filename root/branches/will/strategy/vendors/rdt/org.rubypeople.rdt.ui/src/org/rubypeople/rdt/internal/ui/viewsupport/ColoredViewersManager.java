...
import org.rubypeople.rdt.internal.ui.preferences.AppearancePreferencePage;
import org.rubypeople.rdt.ui.PreferenceConstants;

public class ColoredViewersManager implements IPropertyChangeListener {
	
	public static final String QUALIFIER_COLOR_NAME= "org.rubypeople.rdt.ui.ColoredLabels.qualifier"; //$NON-NLS-1$
	public static final String DECORATIONS_COLOR_NAME= "org.rubypeople.rdt.ui.ColoredLabels.decorations"; //$NON-NLS-1$
	public static final String COUNTER_COLOR_NAME= "org.rubypeople.rdt.ui.ColoredLabels.counter"; //$NON-NLS-1$
	public static final String INHERITED_COLOR_NAME= "org.rubypeople.rdt.ui.ColoredLabels.inherited"; //$NON-NLS-1$
	...
	private class ManagedViewer implements DisposeListener {
		...
		private ColoredString getColoredLabelForView(Item item) {
			...
			if (newLabel == null) {
				...
				newLabel= ColoredRubyElementLabels.decorateColoredString(newLabel, itemText, ColoredRubyElementLabels.DECORATIONS_STYLE);
			}
