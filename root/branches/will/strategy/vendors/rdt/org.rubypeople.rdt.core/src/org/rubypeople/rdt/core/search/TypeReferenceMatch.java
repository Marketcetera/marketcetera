...
/**
 * A Ruby search match that represents a type reference.
...
public class TypeReferenceMatch extends SearchMatch {
	...
	private IRubyElement localElement;
	private IRubyElement[] otherElements;
	 ...
	 */
	public TypeReferenceMatch(IRubyElement enclosingElement, int accuracy,	int offset, int length, SearchParticipant participant, IResource resource) {
		super(enclosingElement, accuracy, offset, length, participant, resource);
		setInsideDocComment(false);
	}
	 ...
	 * @since 3.2
	 */
	public final IRubyElement getLocalElement() {
	 ...
	 * @since 3.2
	 */
	public final IRubyElement[] getOtherElements() {
	 ...
	 * @since 3.2
	 */
	public final void setLocalElement(IRubyElement localElement) {
	 ...
	 * @since 3.2
	 */
	public final void setOtherElements(IRubyElement[] otherElements) {
