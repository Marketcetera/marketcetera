...
public class FIXMarketDataView
    extends MessagesView
    implements IMSymbolListener, IFeedComponentListener, ISubscriber, Messages
{


	public static final String ID = "org.marketcetera.photon.views.FIXMarketDataView";  //$NON-NLS-1$
...
//	private static final int LASTPX_COLUMN_INDEX = 2;
	...
	{
		public MarketDataCellModifier(FIXMarketDataView view) {
		}
	...
	{
	    final FIXMarketDataView theView = this;
		try {
