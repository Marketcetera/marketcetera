...
public class SinkConsoleController implements IConsoleFactory, IConsoleListener, Messages {
	...
	public SinkConsoleController() {
		...
		mModuleManager = ModulePlugin.getDefault().getModuleManager();
	}
	...
	public final void openConsole() {
		if (mConsole == null) {
			mConsole = new MessageConsole(SINK_CONSOLE_NAME.getText(), null);
	...
	protected String format(final Object inFlowID, final Object inData) {
		return inFlowID.toString() + " " + inData.toString();
	}
