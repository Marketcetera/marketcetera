...
public interface ListEventPublisher {
     ...
     * inner classes.
     *
     * <p>For example, the {@link ca.odell.glazedlists.CompositeList} class uses multiple listeners
     ...
     *
     * <p>For example, the {@link ca.odell.glazedlists.ListSelection} class uses a single listener
