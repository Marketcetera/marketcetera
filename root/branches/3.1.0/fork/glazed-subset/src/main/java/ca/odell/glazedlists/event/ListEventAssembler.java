...
public final class ListEventAssembler<E> {
    ...
    /**
     * Create a new {@link ca.odell.glazedlists.event.ListEventPublisher} for an {@link ca.odell.glazedlists.EventList} not attached
     * to any other {@link ca.odell.glazedlists.EventList}s.
     */
    ...
    /**
     * Get all {@link ca.odell.glazedlists.event.ListEventListener}s observing the {@link ca.odell.glazedlists.EventList}.
     */
    ...
    /**
     * Adapt {@link ca.odell.glazedlists.event.SequenceDependenciesEventPublisher.EventFormat} for use with {@link ca.odell.glazedlists.event.ListEvent}s.
     */
