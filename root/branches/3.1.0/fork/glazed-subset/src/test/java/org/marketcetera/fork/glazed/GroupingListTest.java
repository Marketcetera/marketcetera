...
public class GroupingListTest {
    ...
    abstract class TestTemplate implements Runnable {
        ...
        public void run() {
            ...
            Collection contents1 = contents == null ? Collections.EMPTY_LIST : Arrays.asList(contents);
            final EventList<String> result = new BasicEventList<String>(contents1 == null ? 0 : contents1.size());
            if(contents1 != null) result.addAll(contents1);
            EventList<String> base = result;
