...
public final class GroupingList<E> extends TransformedList<E, List<E>> {
     ...
     *
     * @param source the {@link ca.odell.glazedlists.EventList} containing elements to be grouped
     * @param comparator the {@link java.util.Comparator} used to determine groupings
     */
     ...
     * {@link ca.odell.glazedlists.SortedList} which will serve as the source of this list.
     *
     ...
     * grouping {@link java.util.Comparator}, this method is used to rebuild the tree of
    ...
    /**
     * Change the {@link java.util.Comparator} which determines the groupings presented
     * by this List
     *
     * @param comparator the {@link java.util.Comparator} used to determine groupings;
     *      <tt>null</tt> will be treated as {@link ca.odell.glazedlists.GlazedLists#comparableComparator()}
     */
     ...
     * breaks the contract required by {@link java.util.List#add(int, Object)}.
     */
    ...
    private class GroupList extends AbstractList<E> {
         ...
         * within the source {@link ca.odell.glazedlists.SortedList}.
         */
