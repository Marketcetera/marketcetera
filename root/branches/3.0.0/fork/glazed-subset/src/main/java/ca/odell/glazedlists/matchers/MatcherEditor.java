...
/**
 * A facility for modifying the {@link ca.odell.glazedlists.matchers.Matcher}s which specify the behaviour of a
 * {@link ca.odell.glazedlists.FilterList FilterList}.
 *
 * <p>Although this interface is called an <i>Editor</i>, the
 * implementor should create new {@link ca.odell.glazedlists.matchers.Matcher} instances on each
 * change rather than modifying the existing {@link ca.odell.glazedlists.matchers.Matcher}s. This is because
...
public interface MatcherEditor<E> {
    ...
    /**
     * Add a listener to be notified when this editor's {@link ca.odell.glazedlists.matchers.Matcher} changes.
     */
     ...
     * {@link ca.odell.glazedlists.matchers.Matcher} changes.
     */
	public void removeMatcherEditorListener(Listener<E> listener);

	/**
     * Return the current {@link ca.odell.glazedlists.matchers.Matcher} specified by this {@link MatcherEditor}.
     *
     ...
     * creates a new  {@link ca.odell.glazedlists.matchers.Matcher}.
     *
     * <p>The event gives access to:
     * <ul>
     *   <li> the {@link MatcherEditor} which was the source of the change
     *   <li> the new {@link ca.odell.glazedlists.matchers.Matcher} which was produced from the MatcherEditor
    ...
    public class Event<E> extends EventObject {
         ...
         * if this event originated directly from a {@link ca.odell.glazedlists.FilterList} in a call
         * to {@link ca.odell.glazedlists.FilterList#setMatcher(ca.odell.glazedlists.matchers.Matcher)}.
         */
