...
public final class FIXConverter
{
    ...
    private static void addOrderID
        (org.marketcetera.core.trade.OrderID orderID,
         DataDictionary fixDictionary,
         String msgType,
         Message msg,
         boolean required)
    ...
    private static void addOriginalOrderID
        (org.marketcetera.core.trade.OrderID originalOrderID,
         DataDictionary fixDictionary,
         String msgType,
         Message msg,
         boolean required)
    ...
    private static void addSide
        (org.marketcetera.core.trade.Side side,
         DataDictionary fixDictionary,
         String msgType,
         Message msg,
         boolean required)
        throws I18NException
    {
        ...
        if ((side==null) ||
            (side== org.marketcetera.core.trade.Side.Unknown)) {
            if (supported && required) {
    ...
    private static void addPositionEffect
        (org.marketcetera.core.trade.PositionEffect positionEffect,
         DataDictionary fixDictionary,
         String msgType,
         Message msg,
         boolean required)
        throws I18NException
    {
        ...
        if ((positionEffect==null) ||
            (positionEffect== org.marketcetera.core.trade.PositionEffect.Unknown)) {
            if (supported && required) {
                throw new I18NException
                    (new I18NBoundMessage1P
