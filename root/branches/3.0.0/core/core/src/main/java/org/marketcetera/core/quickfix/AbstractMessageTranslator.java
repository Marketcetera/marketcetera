...
public abstract class AbstractMessageTranslator<T>
{
        ...
        throws CoreException
    {
        ...
        try {
            ...
            throw new CoreException(e, 
                                    org.marketcetera.core.marketdata.Messages.ERROR_MARKET_DATA_FEED_CANNOT_FIND_SYMBOL);
        }
        return symbol;
    }
    ...
    public static char determineSubscriptionRequestType(Message inMessage) 
    {
        try {
            ...
            org.marketcetera.core.marketdata.Messages.WARNING_MARKET_DATA_FEED_CANNOT_DETERMINE_SUBSCRIPTION.warn(AbstractMessageTranslator.class, e);
