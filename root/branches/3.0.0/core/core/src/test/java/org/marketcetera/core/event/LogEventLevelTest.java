...
/**
 * Tests {@link org.marketcetera.core.event.LogEventLevel}.
 *
 * @version $Id: LogEventLevelTest.java 82331 2012-04-10 16:29:48Z colin $
 * @since 2.0.0
 */
        ...
        implements Messages
{
    ...
    /**
     * Tests {@link org.marketcetera.core.event.LogEventLevel#shouldLog(org.marketcetera.core.event.LogEvent, String)}.
     *
     * @throws Exception if an unexpected error occurs
     */
    @Test
            ...
            throws Exception
    {
        LogTestAssist.setLevel(category,
                               Level.ERROR);
        // test null values
        assertFalse(LogEventLevel.shouldLog(null, category));
