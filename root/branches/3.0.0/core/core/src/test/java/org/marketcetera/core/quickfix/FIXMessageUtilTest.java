...
import static org.marketcetera.core.quickfix.Messages.CANNOT_CREATE_FIX_FIELD;
...
/*/
           ...
           thisVersion.equals(FIXVersion.FIX44)) {
            ...
            new ExpectedFailure<IllegalStateException>() {
                ...
                protected void run()
                        throws Exception
                {
                    msgFactory.newSecurityListRequest("reqID");
                }                
            };
        }
    }
           ...
           thisVersion.equals(FIXVersion.FIX44)) {
            ...
            new ExpectedFailure<IllegalStateException>() {
                ...
                protected void run()
                        throws Exception
                {
                    msgFactory.newDerivativeSecurityListRequest("reqID");
                }                
            };
        }
    }
    ...
    public void testExceptionsInMergeMarketDataMessages() throws Exception {
        ...
        new ExpectedFailure<IllegalArgumentException>(org.marketcetera.core.quickfix.Messages.FIX_MD_MERGE_INVALID_INCOMING_SNAPSHOT.getText()) {
            @Override
            protected void run()
                    throws Exception
            {
        ...
        new ExpectedFailure<IllegalArgumentException>(org.marketcetera.core.quickfix.Messages.FIX_MD_MERGE_INVALID_INCOMING_INCREMENTAL.getText()) {
            @Override
            protected void run()
                    throws Exception
            {
        ...
        throws Exception
    {
        ...
        new ExpectedFailure<CoreException>(CANNOT_CREATE_FIX_FIELD,
                                           "bogus") {
            @Override
            protected void run()
                    throws Exception
