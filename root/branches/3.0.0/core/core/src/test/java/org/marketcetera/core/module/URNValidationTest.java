...
public class URNValidationTest extends ModuleTestBase {
    ...
    public void objectName() throws Exception {
        checkObjectName("metc:my:game:kong","org.marketcetera.core.module:type=my,provider=game,name=kong");
        checkObjectName("metc:::kong","org.marketcetera.core.module:name=kong");
        checkObjectName("metc::same:","org.marketcetera.core.module:provider=same");
        checkObjectName("metc:what::","org.marketcetera.core.module:type=what");
        checkObjectName("metc:strategy:java","org.marketcetera.core.module:type=strategy,provider=java");
        checkObjectName("metc:strategy::billion","org.marketcetera.core.module:type=strategy,name=billion");
        checkObjectName("metc::java:billion","org.marketcetera.core.module:provider=java,name=billion");
