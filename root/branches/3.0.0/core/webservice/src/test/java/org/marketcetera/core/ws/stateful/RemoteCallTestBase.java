...
import org.marketcetera.core.ws.stateless.StatelessRemoteCallTestBase;
import org.marketcetera.core.ws.tags.EqualsTagFilter;
import org.marketcetera.core.ws.tags.SessionId;
import org.marketcetera.core.ws.tags.ValidSessionTagFilter;
...
/**
 * @since 1.0.0
 * @version $Id: RemoteCallTestBase.java 16063 2012-01-31 18:21:55Z colin $
 */
        ...
        try {
            ...
            assertEquals
                (new I18NBoundMessage2P
                 (org.marketcetera.core.ws.stateless.Messages.VERSION_MISMATCH,
        ...
        try {
            ...
            assertEquals
                (new I18NBoundMessage1P
                 (org.marketcetera.core.ws.tags.Messages.SESSION_EXPIRED,
                  TEST_SESSION_D),
                 ((I18NException)(ex.getCause())).getI18NBoundMessage());
        }
