...
public interface IImageKeys {
	...
	public static final String CANCEL_ALL_OPEN_ORDERS = "icons/silk/basket_delete.png"; //$NON-NLS-1$
	
	public static final String STATUS_OFFLINE = "icons/other/grayled.gif"; //$NON-NLS-1$
