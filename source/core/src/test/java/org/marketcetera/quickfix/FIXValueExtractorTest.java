...
public class FIXValueExtractorTest extends FIXVersionedTestCase {
	...
	public void testExtractHumanValue() throws Exception {
		...
		message.setField(new OrderQty(new BigDecimal("123")));
		message.setField(new CumQty(new BigDecimal("124")));
		message.setField(new AvgPx(new BigDecimal("123.4")));
	...
	public void testExtractValue() throws Exception {
		...
		group.setField(new CumQty(new BigDecimal("123")));
		group.setField(new CxlQty(new BigDecimal("123.400")));
		group.setField(new AvgPx(new BigDecimal("123.40")));
		message.addGroup(group);
		group = msgFactory.createGroup(MsgType.LIST_STATUS, NoOrders.FIELD);
		group.setField(new ClOrdID("2"));
		group.setField(new CumQty(new BigDecimal("124")));
		group.setField(new CxlQty(new BigDecimal("124.400")));
		group.setField(new AvgPx(new BigDecimal("124.40")));
		message.addGroup(group);
