...
public class FIXValueExtractorTest extends FIXVersionedTestCase {
	...
	public void testExtractHumanValue() throws Exception {
        ...
        assertEquals(new BigDecimal("123"),
                (BigDecimal) extractor.extractValue(message, OrderQty.FIELD, null, null, null));
        assertEquals(new BigDecimal("124"),
                (BigDecimal) extractor.extractValue(message, CumQty.FIELD, null, null, null));
        assertEquals(new BigDecimal("123.4"),
                (BigDecimal) extractor.extractValue(message, AvgPx.FIELD, null, null, null));
	...
	public void testExtractValue() throws Exception {
        ...
        assertEquals(new BigDecimal("123"),
                (BigDecimal) extractor.extractValue(message, CumQty.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "1"));
        assertEquals(new BigDecimal("123.400"),
                (BigDecimal) extractor.extractValue(message, CxlQty.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "1"));
        assertEquals(new BigDecimal("123.40"),
                (BigDecimal) extractor.extractValue(message, AvgPx.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "1"));

        assertEquals(new BigDecimal("124"),
                (BigDecimal) extractor.extractValue(message, CumQty.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "2"));
        assertEquals(new BigDecimal("124.400"),
                (BigDecimal) extractor.extractValue(message, CxlQty.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "2"));
        assertEquals(new BigDecimal("124.40"),
                (BigDecimal) extractor.extractValue(message, AvgPx.FIELD, NoOrders.FIELD, ClOrdID.FIELD, "2"));
    }
