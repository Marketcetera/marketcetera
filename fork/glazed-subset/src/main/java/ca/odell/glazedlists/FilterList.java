...
/**
 * An {@link ca.odell.glazedlists.EventList} that shows a subset of the elements of a source
 * {@link ca.odell.glazedlists.EventList}. This subset is composed of all elements of the source
 * {@link ca.odell.glazedlists.EventList} that match the filter.
 *
...
public final class FilterList<E> extends TransformedList<E,E> {
     ...
     * source {@link ca.odell.glazedlists.EventList}.
     */
     ...
     * {@link ca.odell.glazedlists.matchers.Matcher}.
     */
    ...
    /**
     * Set the {@link ca.odell.glazedlists.matchers.Matcher} which specifies which elements shall be filtered.
     *
     * <p>This will remove the current {@link ca.odell.glazedlists.matchers.Matcher} or {@link ca.odell.glazedlists.matchers.MatcherEditor}
    ...
    /**
     * Set the {@link ca.odell.glazedlists.matchers.MatcherEditor} which provides a dynamic {@link ca.odell.glazedlists.matchers.Matcher}
     ...
     * contents of this {@link ca.odell.glazedlists.EventList} as filtered elements are unfiltered
     ...
     * contents of this {@link ca.odell.glazedlists.EventList} as elements are further filtered due
     ...
     * of this {@link ca.odell.glazedlists.EventList} as elements are filtered and unfiltered.
     */
    ...
    /**
     * Listens to changes from the current {@link ca.odell.glazedlists.matchers.MatcherEditor} and handles them.
     */
