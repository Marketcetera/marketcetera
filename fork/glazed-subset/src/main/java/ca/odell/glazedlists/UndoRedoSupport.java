 ...
 * undoing and redoing groups of changes to an {@link ca.odell.glazedlists.EventList}. The
 ...
 * not produce an undoable edit. For example, an {@link ca.odell.glazedlists.ObservableElementList}
 * which observes a change of an element, or a call to {@link java.util.List#set} with
 ...
 * {@link ca.odell.glazedlists.BasicEventList} or a trivial wrapper around a BasicEventList which
 * does not affect the order or type of the elements, such as an
 * {@link ca.odell.glazedlists.ObservableElementList}. Advanced transformations, such as
 * {@link ca.odell.glazedlists.SortedList} or {@link ca.odell.glazedlists.FilterList} will not work as expected with this
 * UndoRedoSupport class since their contents are controlled by information
 * outside of themselves ({@link java.util.Comparator}s and
...
public final class UndoRedoSupport<E> {
     ...
     * edit occurs on the given source {@link ca.odell.glazedlists.EventList}.
     */
    ...
    /**
     * This method removes undo/redo support from the {@link ca.odell.glazedlists.EventList} it was
     * installed on. This method is useful when the {@link ca.odell.glazedlists.EventList} must
     * outlive the UndoRedoSupport object itself. The UndoRedoSupport object will become
     * available for garbage collection independently of the {@link ca.odell.glazedlists.EventList}
