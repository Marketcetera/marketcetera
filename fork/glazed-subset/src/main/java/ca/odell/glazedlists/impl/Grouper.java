 ...
 * {@link ca.odell.glazedlists.SortedList} using a {@link java.util.Comparator}. This class uses a delegate
...
public class Grouper<E> {
    ...
    /**
     * Handle changes from the {@link ca.odell.glazedlists.SortedList} by modifying the grouping state.
     ...
     * {@link ca.odell.glazedlists.event.ListEvent}s if desired. The client receives callbacks as groups
    ...
    public interface Client<E> {
         ...
         *      an {@link ca.odell.glazedlists.event.ListEvent#UPDATE} event will cause a group to become
