...
public final class GlazedListsImpl {
    ...
    /**
     * Replace all elements in the target {@link ca.odell.glazedlists.EventList} with the elements in
     * the source {@link java.util.List}.
     *
     * <p>Note that both collections must be sorted prior to execution using the
     * {@link java.util.Comparator} specified.
     */
    public static <E> void replaceAll(EventList<E> target, Collection<E> source, boolean updates, Comparator<E> comparator) {
        ...
        if(comparator == null) {
            comparator = (Comparator<E>) (Comparator<Comparable>) new ComparableComparator();
        }
     ...
     * returns the resulting {@link java.util.Date}.
     */
    ...
    /**
     * Returns a {@link ca.odell.glazedlists.FunctionList.Function} that simply reflects the
    ...
    /**
     * Returns a {@link ca.odell.glazedlists.impl.adt.KeyedCollection} optimized for the values which can be
     * compared.
     *
     * @param positionComparator a Comparator to order position objects
     * @param valueComparator a Comparator to order value objects
     * @return a {@link ca.odell.glazedlists.impl.adt.KeyedCollection} optimized for values which can be
     *      compared
     */
    ...
    /**
     * Returns a {@link ca.odell.glazedlists.impl.adt.KeyedCollection} optimized for the values which cannot
     * be compared.
     *
     * @param positionComparator a Comparator to order position objects
     * @return a {@link ca.odell.glazedlists.impl.adt.KeyedCollection} optimized for values which cannot be
     *      compared
     */
