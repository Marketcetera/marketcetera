...
public final class Matchers {
     ...
     * {@link ca.odell.glazedlists.matchers.MatcherEditor} <i>M</i> which is long lived and many
     * {@link ca.odell.glazedlists.matchers.MatcherEditor.Listener}s, <i>t</i> which must listen to <i>M</i>
     ...
     * <p/>
     * The {@link ca.odell.glazedlists.matchers.MatcherEditor} returned by this method makes implementing the
     * above scheme trivial. It does two things for you automatically:
     * <p/>
     * <ol>
     * <li>It wraps each {@link ca.odell.glazedlists.matchers.MatcherEditor.Listener} passed to
     * {@link ca.odell.glazedlists.matchers.MatcherEditor#addMatcherEditorListener} in a
    ...
    /**
     * Get a {@link ca.odell.glazedlists.matchers.Matcher} that always returns true, therefore matching everything.
     */
    ...
    /**
     * Get a {@link ca.odell.glazedlists.matchers.Matcher} that always returns false, therefore matching nothing..
     */
    ...
    /**
     * Get a {@link ca.odell.glazedlists.matchers.Matcher} that returns the opposite of the specified {@link ca.odell.glazedlists.matchers.Matcher}.
     */
    ...
    /**
     * Get a {@link ca.odell.glazedlists.matchers.Matcher} that returns returns <tt>true</tt> iff it is
    ...
    /**
     * Get a {@link ca.odell.glazedlists.matchers.Matcher} that returns <tt>true</tt> iff it is given a
    ...
    /**
     * Creates a {@link ca.odell.glazedlists.matchers.Matcher} that uses Reflection to compare the expectedValue
    ...
    /**
     * Creates a {@link ca.odell.glazedlists.matchers.Matcher} that matches {@link Comparable} objects for
    ...
    /**
     * Creates a {@link ca.odell.glazedlists.matchers.Matcher} that uses the given <code>filterator</code>
    ...
    /**
     * Create a {@link ca.odell.glazedlists.matchers.Matcher} that uses the given <code>propertyNames</code> to match
     * {@link java.beans.PropertyChangeEvent}s by their property name. The concrete behaviour depends on the
     ...
     * @see ca.odell.glazedlists.GlazedLists#beanConnector(Class, ca.odell.glazedlists.matchers.Matcher)
     */
     ...
     * @param matcher    the criteria for considering an element a match
     * @return a new {@link java.util.ArrayList} containing the elements which satisfy
     *         the <code>matcher</code>
     */
     ...
     * {@link java.util.Collection#add} operation.
     *
     * @param collection the Collection to search
     * @param matcher    the criteria for considering an element a match
     * @param results    the Collection into which matching elements are added
     * @return the <code>results</code> {@link java.util.Collection} containing the
