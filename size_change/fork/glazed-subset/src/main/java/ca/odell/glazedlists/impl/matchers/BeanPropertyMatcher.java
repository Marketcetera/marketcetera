...
/**
 * A {@link ca.odell.glazedlists.matchers.Matcher} which uses a {@link ca.odell.glazedlists.impl.beans.BeanProperty} to read a bean property
...
public final class BeanPropertyMatcher<E> implements Matcher<E> {
    ...
    /**
     * Create a new {@link ca.odell.glazedlists.matchers.Matcher} that matches whenever the given property
