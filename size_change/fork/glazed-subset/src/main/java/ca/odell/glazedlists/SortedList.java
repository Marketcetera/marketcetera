...
public final class SortedList<E> extends TransformedList<E,E> {
    ...
    /**
     * Creates a {@link SortedList} that sorts the specified {@link ca.odell.glazedlists.EventList}.
     * All elements in the specified {@link ca.odell.glazedlists.EventList} must implement {@link Comparable}.
     *
     * @param source the {@link ca.odell.glazedlists.EventList} to be sorted
     */
     ...
     * <p>Usage of factory method {@link #create(ca.odell.glazedlists.EventList)} is preferable.
     *
     * @param source the {@link ca.odell.glazedlists.EventList} to be sorted
     */
    public SortedList(EventList<E> source) {
        this(source, (Comparator<E>) new ComparableComparator());
    }
    ...
    /**
     * Set the {@link java.util.Comparator} in use in this {@link ca.odell.glazedlists.EventList}. This will
     * sort the source {@link ca.odell.glazedlists.EventList} into a new order.
     *
     ...
     * {@link ca.odell.glazedlists.impl.adt.barcode2.Element}, it will compare the object directly to the object
     * in the source {@link ca.odell.glazedlists.EventList} referenced by the {@link ca.odell.glazedlists.impl.adt.barcode2.Element}.
     * This functionality is necessary to allow use of the underlying
     * {@link java.util.Comparator} within {@link ca.odell.glazedlists.impl.adt.barcode2.SimpleTree} to support {@link java.util.List#indexOf},
