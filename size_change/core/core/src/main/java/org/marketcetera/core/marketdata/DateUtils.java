...
public class DateUtils
{
    ...
    public static final DateTimeFormatter TZ = new DateTimeFormatterBuilder().appendTimeZoneOffset("Z",true,2,4).toFormatter();
    /**
        ...
        throws MarketDataRequestException
    {
        if(inDateString == null ||
           inDateString.isEmpty()) {
            throw new MarketDataRequestException(new I18NBoundMessage1P(Messages.INVALID_DATE,
                                                                        inDateString));
        }
