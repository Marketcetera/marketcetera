 ...
 *
 * @version $Id: InstrumentToMessageTest.java 16063 2012-01-31 18:21:55Z colin $
 * @since 2.0.0
 */
...
public class InstrumentToMessageTest {
    ...
    /**
     * Tests {@link InstrumentToMessage#setSecurityType(org.marketcetera.core.trade.Instrument, String, quickfix.Message)}.
     *
     * @throws Exception if there were unexpected errors.
     */
    @Test
    ...
    private static final ConvertibleSecurity TEST_CONVERTIBLE_BOND = new ConvertibleSecurity("US013817AT86");
