...
/**
 * Breaks ruby text into word starts, also stops at line start and end. No
 * direction dependency.
 *
 * @since 1.0
 */
public class RubyWordIterator extends BreakIterator {

	/**
	 * The underlying java break iterator. It returns all breaks, including
	 * before and after every whitespace.
	 */
	private RubyBreakIterator fIterator;
	 ...
	 */
	public RubyWordIterator() {
		fIterator= new RubyBreakIterator();
		first();
	}
