...
public class FilterDescriptor implements Comparable, IPluginContribution {
    ...
    private static final String EXTENSION_POINT_NAME= "rubyElementFilters"; //$NON-NLS-1$
    ...
    public static FilterDescriptor[] getFilterDescriptors() {
        if (fgFilterDescriptors == null) {
            ...
            IConfigurationElement[] elements= registry.getConfigurationElementsFor(RubyUI.ID_PLUGIN, EXTENSION_POINT_NAME);
