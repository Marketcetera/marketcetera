...
public class MemberFilterActionGroup extends ActionGroup {
    ...
    public MemberFilterActionGroup(StructuredViewer viewer, String viewerId, boolean inViewMenu, int availableFilters) {    
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            helpContext= IRubyHelpContextIds.FILTER_FIELDS_ACTION;
            ...
            RubyPluginImages.setLocalImageDescriptors(hideFields, "fields_co.gif"); //$NON-NLS-1$
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            helpContext= IRubyHelpContextIds.FILTER_STATIC_ACTION;
            ...
            RubyPluginImages.setLocalImageDescriptors(hideStatic, "static_co.gif"); //$NON-NLS-1$
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            helpContext= IRubyHelpContextIds.FILTER_PUBLIC_ACTION;
            ...
            RubyPluginImages.setLocalImageDescriptors(hideNonPublic, "public_co.gif"); //$NON-NLS-1$
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            helpContext= IRubyHelpContextIds.FILTER_LOCALTYPES_ACTION;
            ...
            RubyPluginImages.setLocalImageDescriptors(hideLocalTypes, "localtypes_co.gif"); //$NON-NLS-1$
