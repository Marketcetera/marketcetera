 ...
 * @since 0.5.0
 * @version $Id: SetterContextConsoleTest.java 82324 2012-04-09 20:56:08Z colin $
 */
    ...
    extends SetterContextTestBase
{
        ...
        throws Exception
    {
        ...
        simpleContextWithName
            (new ConsoleContext(true),
             setter,true,true, org.marketcetera.security.Messages.CONSOLE_NAME,TEST_CONSOLE);
        simpleContextWithName
            (new ConsoleContext(false),
             setter,false,true, org.marketcetera.security.Messages.CONSOLE_NAME,TEST_CONSOLE);
        simpleContextWithName
        ...
        simpleContextWithName
            (new ConsoleContext(false),
             setter,false,false, org.marketcetera.security.Messages.CONSOLE_NAME,TEST_CONSOLE);
        simpleContextWithName
            (new ConsoleContext(TestMessages.TEST_CONTEXT,true),
             setter,true,true,TestMessages.TEST_CONTEXT,TEST_CONTEXT);
        simpleContextWithName
        ...
        throws Exception
    {
        ...
        try {
            ...
            assertEquals
                (ex.getDetail(), org.marketcetera.security.Messages.CONSOLE_UNAVAILABLE,
        ...
        throws Exception
    {
        Holder<String> userHolder=
            new Holder<String>(org.marketcetera.security.Messages.NO_USER);
        HolderCharArray passwordHolder=
            new HolderCharArray(org.marketcetera.security.Messages.NO_PASSWORD);

        ConsoleSetterString userSetter=new ConsoleSetterString
            (userHolder,
             org.marketcetera.security.Messages.USER_CONSOLE_USAGE, org.marketcetera.security.Messages.USER_PROMPT);
        ConsoleSetterCharArray passwordSetter=new ConsoleSetterCharArray
            (passwordHolder,
             org.marketcetera.security.Messages.PASSWORD_CONSOLE_USAGE, org.marketcetera.security.Messages.PASSWORD_PROMPT);
