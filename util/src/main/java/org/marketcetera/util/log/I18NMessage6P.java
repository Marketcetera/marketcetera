 ...
 * @since 0.5.0
 * @version $Id: I18NMessage6P.java 17760 2018-11-14 14:54:11Z colin $
 */

/* $License$ */

@ClassVersion("$Id: I18NMessage6P.java 17760 2018-11-14 14:54:11Z colin $")
    ...
    extends I18NMessage
{
     ...
     */
    private final static String SELF_PROXY = I18NMessage6P.class.getName();
    /**
     ...
     */
    public I18NMessage6P(I18NLoggerProxy loggerProxy,
                         String messageId,
                         String entryId)
    {
     ...
     * @param p6 an <code>Object</code> value
