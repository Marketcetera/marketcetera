...
final class Messages {
    ...
    static I18NMessage0P ORDER_TICKET_VIEW_DISPLAYQUANTITY__LABEL;
    ...
    static I18NMessage0P FUTURE_ORDER_TICKET_VIEW_NEW__HEADING;
    static I18NMessage0P FUTURE_ORDER_TICKET_VIEW_REPLACE__HEADING;
    static I18NMessage0P FUTURE_ORDER_TICKET_VIEW_EXPIRATION_YEAR__LABEL;
    static I18NMessage0P FUTURE_ORDER_TICKET_VIEW_EXPIRATION_MONTH__LABEL;
    static I18NMessage0P CURRENCY_ORDER_TICKET_VIEW_NEW__HEADING;
    static I18NMessage0P CURRENCY_ORDER_TICKET_VIEW_REPLACE__HEADING;
    static I18NMessage0P CURRENCY_ORDER_TICKET_VIEW_NEAR_TENOR__LABEL;
    static I18NMessage0P CURRENCY_ORDER_TICKET_VIEW_FAR_TENOR__LABEL;
    static {
