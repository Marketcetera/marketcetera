 ...
 *
 */
public class CurrencyPerspectiveFactory
        implements IPerspectiveFactory
{
    ...
    public void createInitialLayout(IPageLayout inLayout)
    {
        ...
        topFolder = inLayout.createFolder(TOP_FOLDER,
                                          ...
                                          0.55f,
                                          RIGHT_FOLDER);
        topFolder.addPlaceholder(CurrencyOrderTicketView.ID + SECONDARY_ID_WILDCARD);
        topFolder.addView(CurrencyOrderTicketView.ID);
    }
    ...
    public static final String ID = "org.marketcetera.photon.CurrencyPerspective"; //$NON-NLS-1$
