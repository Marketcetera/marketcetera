...
final class Messages {
    ...
    static I18NMessage0P EMBEDDED_CONNECTION_MISSING_SCRIPT_PATH;
    static I18NMessage0P EMBEDDED_CONNECTION_MISSING_CLASS_NAME;
    static I18NMessage0P EMBEDDED_CONNECTION_MISSING_LANGUAGE;
    static I18NMessage0P EMBEDDED_CONNECTION_MISSING_INSTANCE_NAME;
    static I18NMessage1P EMBEDDED_CONNECTION_INVALID_SCRIPT_PATH;
