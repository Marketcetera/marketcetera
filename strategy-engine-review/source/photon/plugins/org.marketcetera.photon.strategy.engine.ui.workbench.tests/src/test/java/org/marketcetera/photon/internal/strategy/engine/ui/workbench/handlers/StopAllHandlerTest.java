...
public class StopAllHandlerTest extends PhotonTestBase {
    ...
    public void test() throws Exception {
        ...
        ContextMenuHelper.clickContextMenu(tree, "Stop All");
        Thread.sleep(500);
        AbstractUIRunner.syncRun(new ThrowableRunnable() {
            @Override
            public void run() throws Throwable {
                assertThat(mStrategy1.getState(), is(StrategyState.STOPPED));
                assertThat(mStrategy2.getState(), is(StrategyState.STOPPED));
