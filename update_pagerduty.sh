#!/bin/bash
# Script to update PagerDutyNotificationExecutorMethod to use HttpClient 5.x

cat > /tmp/PagerDutyNotificationExecutorMethod.java <<'EOF'
...
mv /tmp/PagerDutyNotificationExecutorMethod.java /Users/colin/marketcetera/workspaces/sixer-java11/code/marketcetera/core/src/main/java/org/marketcetera/core/notifications/PagerDutyNotificationExecutorMethod.java

echo "PagerDutyNotificationExecutorMethod updated to use HTTPClient 5.x"