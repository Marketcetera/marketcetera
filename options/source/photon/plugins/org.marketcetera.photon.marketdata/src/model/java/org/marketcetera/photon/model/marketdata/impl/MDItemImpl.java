 ...
 * <ul>
 *   <li>{@link org.marketcetera.photon.model.marketdata.impl.MDItemImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MDItemImpl extends EObjectImpl implements MDItem {
	...
	public void setSymbol(String newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDPackage.MD_ITEM__SYMBOL,
					oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MDPackage.MD_ITEM__SYMBOL:
			return getSymbol();
		}
