...
public class TradeReportsHistoryTest extends FIXVersionedTestCase {
	...
	protected TradeReportsHistory getMessageHistory() {
		return new TradeReportsHistory(msgFactory);
	}

	public void testAddIncomingMessage() throws Exception {
		TradeReportsHistory history = getMessageHistory();
	...
	public void testGetLatestExecutionReports() throws Exception {
		...
		TradeReportsHistory history = getMessageHistory();
		Message order1 = msgFactory
				.newMarketOrder(
						"1", Side.BUY, new BigDecimal(1000), new MSymbol("ASDF"), TimeInForce.FILL_OR_KILL, "1"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		assertEquals(order1.getString(ClOrdID.FIELD),
		...
		assertEquals(order1.getString(OrderQty.FIELD),
				historyExecutionReportForOrder1.getOrderQuantity().toString());
		// TODO: add this back once ExecutionReportImpl#getSymbol is fixed
//		assertEquals(order1.getString(Symbol.FIELD),
//				historyExecutionReportForOrder1.getSymbol());
...
//				historyExecutionReportForOrder2.getSymbol());
	}
	...
	public void testGetLatestMessage() throws Exception {
		...
		assertEquals(order1.getString(Side.FIELD),
	...
	public void testOrderCancelReject() throws Exception {
...

		{
			Message order2 = msgFactory
					.newMarketOrder(
							"2", Side.BUY, new BigDecimal(1000), new MSymbol("ASDF"), TimeInForce.FILL_OR_KILL, "1"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			Message executionReportForOrder2 = msgFactory
					.newExecutionReport(
	...
	public void testAveragePriceList() throws Exception {
		TradeReportsHistory messageHistory = getMessageHistory();
		String orderID1 = "1"; //$NON-NLS-1$
	...
	public void testAveragePriceList2() throws Exception {
		TradeReportsHistory hist = getMessageHistory();
	...
	public void testStrandedOpenOrder() throws Exception {
		FIXMessageHistory history = new FIXMessageHistory(fixVersion
				.getMessageFactory());
