...
import com.marketcetera.ors.LongIDFactory;
        ...
        implements ReportHistoryServices
{
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#getOpenOrders(com.marketcetera.ors.security.SimpleUser)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#getRootOrderIdFor(org.marketcetera.trade.OrderID)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#getAllCurrencyPositionsAsOf(com.marketcetera.ors.security.SimpleUser, java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#getAllFuturePositionsAsOf(com.marketcetera.ors.security.SimpleUser, java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#getFuturePositionAsOf(com.marketcetera.ors.security.SimpleUser, java.util.Date, org.marketcetera.trade.Future)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#save(org.marketcetera.trade.ReportBase)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.history.ReportHistoryServices#delete(org.marketcetera.trade.ReportBase)
     */
    @Override
