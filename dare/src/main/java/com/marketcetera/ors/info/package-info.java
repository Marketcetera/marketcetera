 ...
 * com.marketcetera.ors.info.InfoRuntimeException} is thrown.</p>
 *
 * <p>Stores are nested: a request store {@link
 * com.marketcetera.ors.info.RequestInfo} is contained in a session
 * store {@link com.marketcetera.ors.info.SessionInfo}, and that in
 * turn is contained in the (usually singleton) system store {@link
 * com.marketcetera.ors.info.SystemInfo}.</p>
 *
 ...
 * {@link
 * com.marketcetera.ors.info.ReadWriteInfo#setValueIfUnset(String,Object)}
