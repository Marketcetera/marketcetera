...
import static org.marketcetera.ors.history.ExecutionReportSummary.DECIMAL_PRECISION;
import static org.marketcetera.ors.history.ExecutionReportSummary.DECIMAL_SCALE;
...
public class PersistentOrderStatus
        extends EntityBase
        implements OrderStatus
{
    /**
     * Create a new PersistentOrderStatus instance.
     */
    public PersistentOrderStatus()
    {
    }
    /**
     * Create a new PersistentOrderStatus instance.
     ...
     */
    public PersistentOrderStatus(OrderStatus inOrderStatus)
    {
        ...
        report = inOrderStatus.getReport();
     ...
     */
    public PersistentOrderStatus(PersistentReport inReport,
    ...
    public String toString()
    {
        ...
        builder.append("PersistentOrderStatus [instrument=").append(getInstrument()).append(", rootOrderId=")
