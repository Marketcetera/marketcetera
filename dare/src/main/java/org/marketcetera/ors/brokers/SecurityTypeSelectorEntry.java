 ...
 * @version $Id: SecurityTypeSelectorEntry.java 16522 2014-12-31 16:33:08Z colin $
 * @since 2.4.2
 */
...
{
    /* (non-Javadoc)
     * @see com.marketcetera.ors.brokers.SpringSelectorEntry#routeToBroker(org.marketcetera.trade.Order)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.brokers.SpringSelectorEntry#setBroker(com.marketcetera.ors.brokers.SpringBroker)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.brokers.SpringSelectorEntry#getBroker()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.brokers.SpringSelectorEntry#setSkipIfUnavailable(boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.marketcetera.ors.brokers.SpringSelectorEntry#getSkipIfUnavailable()
     */
    @Override
