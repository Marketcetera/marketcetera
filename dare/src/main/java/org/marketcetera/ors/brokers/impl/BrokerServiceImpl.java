...
import org.marketcetera.fix.dao.FixSessionAttributeDescriptorDao;
import org.marketcetera.fix.dao.FixSessionDao;
import org.marketcetera.fix.dao.PersistentFixSession;
import org.marketcetera.fix.dao.PersistentFixSessionAttributeDescriptor;
import org.marketcetera.fix.dao.QPersistentFixSession;
import org.marketcetera.ors.brokers.Broker;
import org.marketcetera.ors.brokers.BrokerConstants;
import org.marketcetera.ors.brokers.BrokerService;
import org.marketcetera.ors.brokers.Brokers;
import org.marketcetera.ors.brokers.SessionCustomization;
        ...
        implements BrokerService,MembershipListener,ClusterListener
{
    ...
    public FixSession findFixSessionById(long inId)
    {
        ...
        FixSession session = fixSessionDao.findOne(where).orElse(null);
        if(session != null) {
    ...
    public FixSession save(FixSession inFixSession)
    {
        ...
        PersistentFixSession existingSession = fixSessionDao.findOne(where).orElse(null);
