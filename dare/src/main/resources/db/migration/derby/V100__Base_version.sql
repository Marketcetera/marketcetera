CREATE SEQUENCE METC.HIBERNATE_SEQUENCE AS BIGINT START WITH 121;
...
CREATE TABLE METC.SUPERVISOR_PERMISSIONS_PERMISSIONS (
	...
	PERMISSIONS_ID BIGINT NOT NULL,
	PRIMARY KEY (PERMISSIONS_ID,supervisor_permission_id)
);
CREATE TABLE METC.SUPERVISOR_PERMISSIONS_USERS (
	supervisor_permission_id BIGINT NOT NULL,
	SUBJECTS_ID BIGINT NOT NULL,
	PRIMARY KEY (SUBJECTS_ID,supervisor_permission_id)
);
...
INSERT INTO METC.SUPERVISOR_PERMISSIONS_PERMISSIONS(supervisor_permission_id, PERMISSIONS_ID) VALUES (43, 29);
INSERT INTO METC.SUPERVISOR_PERMISSIONS_PERMISSIONS(supervisor_permission_id, PERMISSIONS_ID) VALUES (43, 30);
INSERT INTO METC.SUPERVISOR_PERMISSIONS_PERMISSIONS(supervisor_permission_id, PERMISSIONS_ID) VALUES (43, 31);
INSERT INTO METC.SUPERVISOR_PERMISSIONS_PERMISSIONS(supervisor_permission_id, PERMISSIONS_ID) VALUES (43, 32);
INSERT INTO METC.SUPERVISOR_PERMISSIONS_PERMISSIONS(supervisor_permission_id, PERMISSIONS_ID) VALUES (43, 34);
INSERT INTO METC.SUPERVISOR_PERMISSIONS_USERS(supervisor_permission_id, SUBJECTS_ID) VALUES (43, 1);
INSERT INTO METC.USERS(ID, LAST_UPDATED, UPDATE_COUNT, DESCRIPTION, NAME, IS_ACTIVE, PASSWORD, IS_SUPERUSER, USER_DATA) VALUES (1, '2018-11-16 10:25:08.946', 0, 'Trader user', 'trader', true, '$2a$10$ISknot6OPe/PI1dQdKmTluxSrRyJwOVI5ex31XdqGPHlWl6vuTseW', false, null);
INSERT INTO METC.USERS(ID, LAST_UPDATED, UPDATE_COUNT, DESCRIPTION, NAME, IS_ACTIVE, PASSWORD, IS_SUPERUSER, USER_DATA) VALUES (2, '2018-11-16 10:25:09.01', 0, 'Trader Admin user', 'traderAdmin', true, '$2a$10$N6ADcu9ZdD3tFik0lkMRJO7PO0XFbxAjNMhujBjp6F0n3iJyVoGgG', false, null);
INSERT INTO METC.USERS(ID, LAST_UPDATED, UPDATE_COUNT, DESCRIPTION, NAME, IS_ACTIVE, PASSWORD, IS_SUPERUSER, USER_DATA) VALUES (3, '2018-11-16 10:25:09.019', 0, 'Admin user', 'admin', true, '$2a$10$kfVP4tGnFJrZf1pcjo5pVe7cbyVUguMYoz4tgP12gubXlbNwRJuP.', true, null);
...
ALTER TABLE METC.SUPERVISOR_PERMISSIONS_PERMISSIONS
	ADD FOREIGN KEY (supervisor_permission_id) 
