SET DATABASE UNIQUE NAME HSQLDB75F118E21A
SET DATABASE GC 0
...
CREATE USER "metc" PASSWORD DIGEST '59f7d99332dd9256faa406d06fc7cbdf'
...
CREATE MEMORY TABLE PUBLIC.EXEC_REPORTS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,ACCOUNT VARCHAR(255),AVG_PRICE NUMERIC(17,7) NOT NULL,CUM_QTY NUMERIC(17,7) NOT NULL,EFF_CUM_QTY NUMERIC(17,7) NOT NULL,EXEC_TYPE INTEGER NOT NULL,EXPIRY VARCHAR(255),LAST_PRICE NUMERIC(17,7),LAST_QTY NUMERIC(17,7),OPTION_TYPE INTEGER,ORDER_ID VARCHAR(255) NOT NULL,ORD_STATUS INTEGER NOT NULL,ORIG_ORDER_ID VARCHAR(255),ROOT_ORDER_ID VARCHAR(255) NOT NULL,SECURITY_TYPE INTEGER NOT NULL,SEND_TIME TIMESTAMP NOT NULL,SIDE INTEGER NOT NULL,STRIKE_PRICE NUMERIC(17,7),SYMBOL VARCHAR(255) NOT NULL,ACTOR_ID BIGINT,REPORT_ID BIGINT NOT NULL,VIEWER_ID BIGINT,CONSTRAINT UK_IMDQ099U0QA8OB9TT5LJM6F7U UNIQUE(REPORT_ID))
CREATE MEMORY TABLE PUBLIC.FIX_MESSAGES(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,MESSAGE CLOB(8K) NOT NULL)
CREATE MEMORY TABLE PUBLIC.FIX_SESSION_ATTR_DSCRPTRS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,ADVICE VARCHAR(255),DEFAULT_VALUE VARCHAR(255),DESCRIPTION VARCHAR(1024),NAME VARCHAR(255) NOT NULL,PATTERN VARCHAR(255),REQUIRED BOOLEAN NOT NULL,CONSTRAINT UK_GB3X058KYH5S4FXW1FI67BYSC UNIQUE(NAME))
CREATE MEMORY TABLE PUBLIC.FIX_SESSION_ATTRIBUTES(FIX_SESSION_ID BIGINT NOT NULL,VALUE VARCHAR(255),NAME VARCHAR(255) NOT NULL,PRIMARY KEY(FIX_SESSION_ID,NAME))
CREATE MEMORY TABLE PUBLIC.FIX_SESSIONS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,AFFINITY INTEGER NOT NULL,BROKER_ID VARCHAR(255) NOT NULL,DESCRIPTION VARCHAR(255),HOST VARCHAR(255) NOT NULL,ACCEPTOR BOOLEAN NOT NULL,DELETED BOOLEAN NOT NULL,ENABLED BOOLEAN NOT NULL,NAME VARCHAR(255) NOT NULL,PORT INTEGER NOT NULL,SESSION_ID VARCHAR(255) NOT NULL)
CREATE MEMORY TABLE PUBLIC.ID_REPOSITORY(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,NEXT_ID BIGINT)
CREATE MEMORY TABLE PUBLIC.INCOMING_FIX_MESSAGES(ID BIGINT NOT NULL PRIMARY KEY,CLORDID VARCHAR(255),EXECID VARCHAR(255),MESSAGE VARCHAR(4000) NOT NULL,MSG_SEQ_NUM INTEGER NOT NULL,MSG_TYPE VARCHAR(255) NOT NULL,SENDING_TIME TIMESTAMP NOT NULL,FIX_SESSION VARCHAR(255) NOT NULL)
CREATE MEMORY TABLE PUBLIC.MESSAGE_STORE_MESSAGES(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,SESSION_ID VARCHAR(255) NOT NULL,MESSAGE VARCHAR(8192) NOT NULL,MSG_SEQ_NUM INTEGER NOT NULL)
CREATE MEMORY TABLE PUBLIC.MESSAGE_STORE_SESSIONS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,SESSION_ID VARCHAR(255) NOT NULL,CREATION_TIME TIMESTAMP NOT NULL,SENDER_SEQ_NUM INTEGER NOT NULL,TARGET_SEQ_NUM INTEGER NOT NULL)
CREATE MEMORY TABLE PUBLIC.ORDER_STATUS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,ACCOUNT VARCHAR(255),AVG_PX NUMERIC(17,7) NOT NULL,BROKER_ID VARCHAR(255),CUM_QTY NUMERIC(17,7) NOT NULL,EXPIRY VARCHAR(255),LAST_PX NUMERIC(17,7) NOT NULL,LAST_QTY NUMERIC(17,7) NOT NULL,LEAVES_QTY NUMERIC(17,7) NOT NULL,OPTION_TYPE INTEGER,ORDER_ID VARCHAR(255) NOT NULL,ORDER_PX NUMERIC(17,7),ORDER_QTY NUMERIC(17,7) NOT NULL,ORD_STATUS VARCHAR(255) NOT NULL,ROOT_ORDER_ID VARCHAR(255) NOT NULL,SECURITY_TYPE INTEGER NOT NULL,SENDING_TIME TIMESTAMP NOT NULL,SIDE INTEGER NOT NULL,STRIKE_PRICE NUMERIC(17,7),SYMBOL VARCHAR(255) NOT NULL,EXECUTION_TIME TIMESTAMP,ACTOR_ID BIGINT,REPORT_ID BIGINT NOT NULL,VIEWER_ID BIGINT,CONSTRAINT UK_H8V9N38CYDUSMK1D0YYA6ND2D UNIQUE(REPORT_ID))
CREATE MEMORY TABLE PUBLIC.OUTGOING_MESSAGES(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,BROKER_ID VARCHAR(255) NOT NULL,MESSAGE_TYPE VARCHAR(255) NOT NULL,MSG_SEQ_NUM INTEGER,ORDER_ID VARCHAR(255),SENDER_COMP_ID VARCHAR(255) NOT NULL,SESSION_ID VARCHAR(255) NOT NULL,TARGET_COMP_ID VARCHAR(255) NOT NULL,ACTOR_ID BIGINT NOT NULL,FIX_MESSAGE_ID BIGINT NOT NULL,CONSTRAINT UK_HXVC6VRTMW1SWIK69WXT0DRLC UNIQUE(FIX_MESSAGE_ID),CONSTRAINT FK7AESWC52COXK8SSPDT9UA5E15 FOREIGN KEY(FIX_MESSAGE_ID) REFERENCES PUBLIC.FIX_MESSAGES(ID))
CREATE MEMORY TABLE PUBLIC.PERMISSIONS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,DESCRIPTION VARCHAR(255),NAME VARCHAR(255) NOT NULL,CONSTRAINT UK_PNVTWLIIS6P05PN6I3NDJRQT2 UNIQUE(NAME))
CREATE MEMORY TABLE PUBLIC.REPORTS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,BROKER_ID VARCHAR(255),HIERARCHY INTEGER,ORIGINATOR INTEGER,REPORT_TYPE INTEGER NOT NULL,MSG_SEQ_NUM INTEGER NOT NULL,ORDER_ID VARCHAR(255) NOT NULL,REPORT_ID BIGINT NOT NULL,SEND_TIME TIMESTAMP NOT NULL,SESSION_ID VARCHAR(255) NOT NULL,ACTOR_ID BIGINT,FIX_MESSAGE_ID BIGINT NOT NULL,VIEWER_ID BIGINT,CONSTRAINT UK_CA90A4KKDYCPON22YNLI3D6OI UNIQUE(FIX_MESSAGE_ID),CONSTRAINT UK_AELY7CHRVTQWV4XFM76XUJ5BH UNIQUE(REPORT_ID),CONSTRAINT FK98BMVK76E2GP10MUHEOG0J1WA FOREIGN KEY(FIX_MESSAGE_ID) REFERENCES PUBLIC.FIX_MESSAGES(ID))
CREATE MEMORY TABLE PUBLIC.ROLES(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,DESCRIPTION VARCHAR(255),NAME VARCHAR(255) NOT NULL,CONSTRAINT UK_OFX66KERUAPI6VYQPV6F2OR37 UNIQUE(NAME))
CREATE MEMORY TABLE PUBLIC.ROLES_PERMISSIONS(ROLES_ID BIGINT NOT NULL,PERMISSIONS_ID BIGINT NOT NULL,PRIMARY KEY(ROLES_ID,PERMISSIONS_ID),CONSTRAINT FK570WUY6SACDNRW8WDQJFH7J0Q FOREIGN KEY(PERMISSIONS_ID) REFERENCES PUBLIC.PERMISSIONS(ID),CONSTRAINT FKB9GQC5KVLA3IJOVNIHSBB816E FOREIGN KEY(ROLES_ID) REFERENCES PUBLIC.ROLES(ID))
CREATE MEMORY TABLE PUBLIC.ROLES_USERS(ROLE_ID BIGINT NOT NULL,SUBJECTS_ID BIGINT NOT NULL,PRIMARY KEY(ROLE_ID,SUBJECTS_ID),CONSTRAINT FKRXA1KWVAC3VQ2P3A4AUS28M3P FOREIGN KEY(ROLE_ID) REFERENCES PUBLIC.ROLES(ID))
CREATE MEMORY TABLE PUBLIC.SUPERVISOR_PERMISSIONS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,DESCRIPTION VARCHAR(255),NAME VARCHAR(255) NOT NULL,USER_ID BIGINT NOT NULL,CONSTRAINT UK_4RD5TOWBSHLB1V1HV6W00SF6B UNIQUE(NAME))
CREATE MEMORY TABLE PUBLIC.SUPERVISOR_PERMISSIONS_PERMISSIONS(SUPERVISORPERMISSION_ID BIGINT NOT NULL,PERMISSIONS_ID BIGINT NOT NULL,PRIMARY KEY(SUPERVISORPERMISSION_ID,PERMISSIONS_ID),CONSTRAINT FKTKCTB5N3GGMU727F5MWLMUTK3 FOREIGN KEY(PERMISSIONS_ID) REFERENCES PUBLIC.PERMISSIONS(ID),CONSTRAINT FK6B5T61SOYNLXLYRMB8Y59Y6TF FOREIGN KEY(SUPERVISORPERMISSION_ID) REFERENCES PUBLIC.SUPERVISOR_PERMISSIONS(ID))
CREATE MEMORY TABLE PUBLIC.SUPERVISOR_PERMISSIONS_USERS(SUPERVISORPERMISSION_ID BIGINT NOT NULL,SUBJECTS_ID BIGINT NOT NULL,PRIMARY KEY(SUPERVISORPERMISSION_ID,SUBJECTS_ID),CONSTRAINT FK16N73Q253VU1UNEMUPOBM3EKJ FOREIGN KEY(SUPERVISORPERMISSION_ID) REFERENCES PUBLIC.SUPERVISOR_PERMISSIONS(ID))
CREATE MEMORY TABLE PUBLIC.USER_ATTRIBUTES(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,ATTRIBUTE CLOB(256K) NOT NULL,USER_ATTRIBUTE_TYPE INTEGER NOT NULL,USER_ID BIGINT)
CREATE MEMORY TABLE PUBLIC.USERS(ID BIGINT NOT NULL PRIMARY KEY,LAST_UPDATED TIMESTAMP NOT NULL,UPDATE_COUNT INTEGER NOT NULL,DESCRIPTION VARCHAR(255),NAME VARCHAR(255) NOT NULL,IS_ACTIVE BOOLEAN NOT NULL,PASSWORD VARCHAR(255) NOT NULL,IS_SUPERUSER BOOLEAN NOT NULL,USER_DATA CLOB(8096),CONSTRAINT UK3G1J96G94XPK3LPXL2QBL985X UNIQUE(NAME))
ALTER TABLE PUBLIC.EXEC_REPORTS ADD CONSTRAINT FKFN47LJ607GHTT1LFIE8ADEVXC FOREIGN KEY(ACTOR_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.EXEC_REPORTS ADD CONSTRAINT FKN47TA2B6E9WIH8B97OUBXVD3S FOREIGN KEY(REPORT_ID) REFERENCES PUBLIC.REPORTS(ID)
ALTER TABLE PUBLIC.EXEC_REPORTS ADD CONSTRAINT FK1CELHYPJ9VINT37EOBSN22S1B FOREIGN KEY(VIEWER_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.FIX_SESSION_ATTRIBUTES ADD CONSTRAINT FK3LRQYAMU7790PIE2IVJH8VFQ5 FOREIGN KEY(FIX_SESSION_ID) REFERENCES PUBLIC.FIX_SESSIONS(ID)
ALTER TABLE PUBLIC.ORDER_STATUS ADD CONSTRAINT FKLXKG9IL8Q8K9448O5NGGIBNBS FOREIGN KEY(ACTOR_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.ORDER_STATUS ADD CONSTRAINT FKJQTX22V71DOD89THT0FYWAV7 FOREIGN KEY(REPORT_ID) REFERENCES PUBLIC.REPORTS(ID)
ALTER TABLE PUBLIC.ORDER_STATUS ADD CONSTRAINT FKT8IYSRML49HNMEMBW8PKV5G3N FOREIGN KEY(VIEWER_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.OUTGOING_MESSAGES ADD CONSTRAINT FKPKYA7XSUMLSBFM4B125K07KE8 FOREIGN KEY(ACTOR_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.REPORTS ADD CONSTRAINT FKH0R6PPU75BYN1Y7Y0UITEEL8Q FOREIGN KEY(ACTOR_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.REPORTS ADD CONSTRAINT FKSFC0WDPJFEROHMPYLYGFF4URS FOREIGN KEY(VIEWER_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.ROLES_USERS ADD CONSTRAINT FKJDAU0SN88GJ3B7OIYM39QAYMK FOREIGN KEY(SUBJECTS_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.SUPERVISOR_PERMISSIONS ADD CONSTRAINT FKF7MXSACK9D04S94A2AHA7JYR9 FOREIGN KEY(USER_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.SUPERVISOR_PERMISSIONS_USERS ADD CONSTRAINT FKL8HK9CJ6MAVQ8OQVUN76XL3AG FOREIGN KEY(SUBJECTS_ID) REFERENCES PUBLIC.USERS(ID)
ALTER TABLE PUBLIC.USER_ATTRIBUTES ADD CONSTRAINT FKSKW1X6G2KT3G0I9507K4A4TQW FOREIGN KEY(USER_ID) REFERENCES PUBLIC.USERS(ID)
ALTER SEQUENCE SYSTEM_LOBS.LOB_ID RESTART WITH 1
ALTER SEQUENCE PUBLIC.HIBERNATE_SEQUENCE RESTART WITH 120
...
INSERT INTO BLOCKS(BLOCK_ADDR,BLOCK_COUNT,TX_ID) VALUES(0,2147483647,0)
SET SCHEMA PUBLIC
...
INSERT INTO FIX_SESSION_ATTRIBUTES(FIX_SESSION_ID,VALUE,NAME) VALUES(44,'colin-core-europa','SenderCompID')
...
INSERT INTO FIX_SESSIONS(ID,LAST_UPDATED,UPDATE_COUNT,AFFINITY,BROKER_ID,DESCRIPTION,HOST,ACCEPTOR,DELETED,ENABLED,NAME,PORT,SESSION_ID) VALUES(44,'2020-11-22 09:55:51.763000',1,1,'exsim',NULL,'exchange.marketcetera.com',FALSE,FALSE,TRUE,'MATP Exchange Simulator',7001,'FIXT.1.1:colin-core-europa->MRKTC-EXCH')
INSERT INTO MESSAGE_STORE_MESSAGES(ID,LAST_UPDATED,UPDATE_COUNT,SESSION_ID,MESSAGE,MSG_SEQ_NUM) VALUES(119,'2020-11-22 09:55:54.410000',0,'FIXT.1.1:colin-core-europa->MRKTC-EXCH','8=FIXT.1.1\u00019=95\u000135=A\u000134=1\u000149=colin-core-europa\u000152=20201122-17:55:54.178\u000156=MRKTC-EXCH\u000198=0\u0001108=30\u0001141=Y\u00011137=9\u000110=065\u0001',1)
INSERT INTO MESSAGE_STORE_SESSIONS(ID,LAST_UPDATED,UPDATE_COUNT,SESSION_ID,CREATION_TIME,SENDER_SEQ_NUM,TARGET_SEQ_NUM) VALUES(118,'2020-11-22 09:55:54.466000',4,'FIXT.1.1:colin-core-europa->MRKTC-EXCH','2020-11-22 09:55:54.387000',2,2)
