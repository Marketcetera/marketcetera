 ...
 * @since 2.5.0
 */
public class ClusterWorkUnitSpec
        implements Serializable, Comparable<ClusterWorkUnitSpec>
{
    /**
     * Create a new ClusterWorkUnitSpec instance.
     */
    public ClusterWorkUnitSpec() {}
    /**
     * Create a new ClusterWorkUnitSpec instance.
     *
     ...
     */
    public ClusterWorkUnitSpec(ClusterWorkUnitType inWorkUnitType,
                               String inWorkUnitId,
     ...
     */
    public ClusterWorkUnitSpec(ClusterWorkUnit inWorkUnit)
    {
    ...
    {
        return new CompareToBuilder().append(workUnitId,inO.workUnitId).append(workUnitUid,inO.workUnitUid).toComparison();
    }
    /* (non-Javadoc)
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        ClusterWorkUnitSpec other = (ClusterWorkUnitSpec) obj;
