        ...
        implements ContextClassProvider
{
     ...
     */
    private static final Class<?>[] CLASSES = new Class<?>[] { ModuleInfo.class, XmlValue.class, CreateStrategyParameters.class, DeleteSuggestionAction.class, RefreshSuggestionAction.class };
    /**
     * instance value
     */
