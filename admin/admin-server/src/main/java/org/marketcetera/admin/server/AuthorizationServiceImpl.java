package org.marketcetera.admin.server;
        ...
        implements AuthorizationService
{
    ...
    public void start()
    {
        ...
        subjectUsersByKey = CacheBuilder.newBuilder().expireAfterAccess(userPermissionCacheTtl,TimeUnit.MILLISECONDS).build(new CacheLoader<GetSubjectUsersKey,Set<PersistentUser>>() {
            @Override
            public Set<PersistentUser> load(GetSubjectUsersKey inKey)
                    throws Exception
            {
                Set<PersistentUser> subjects = Sets.newHashSet();
                PersistentPermission permission = permissionDao.findByName(inKey.getPermissionName());
                if(permission == null) {
                    return subjects;
                }
    ...
    private static class GetSubjectUsersKey
            extends Pair<PersistentUser,String>
    {
        /**
         * Get the user value.
         *
     ...
     */
    private LoadingCache<GetSubjectUsersKey,Set<PersistentUser>> subjectUsersByKey;
    /**
