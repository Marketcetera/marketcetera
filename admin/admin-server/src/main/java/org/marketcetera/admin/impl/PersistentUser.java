        ...
        implements User
{
            ...
            throws ValidationException
    {
        ...
        if(isPasswordSet()) {
            throw new ValidationException(new I18NBoundMessage1P(Messages.CANNOT_SET_PASSWORD,
                                                                 getName()));
        }
            ...
            throws ValidationException
    {
        ...
        if(!getHashedPassword().equals(hash(getName().toCharArray(),
                                            password))) {
            throw new ValidationException(Messages.INVALID_PASSWORD);
        }
    }
    /**
    ...
    public void validate() throws ValidationException {
        super.validate();
        if(getHashedPassword() == null || getHashedPassword().length() == 0) {
            throw new ValidationException(Messages.EMPTY_PASSWORD);
        }
    }
    /**
