...
import com.marketcetera.fix.FixAdminRpcServiceGrpc.FixAdminRpcServiceBlockingStub;
import com.marketcetera.fix.FixAdminRpcServiceGrpc.FixAdminRpcServiceStub;
        ...
        return executeCall(new Callable<InstanceData>() {
                    ...
                    throws Exception
            {
                ...
                SLF4JLoggerProxy.trace(FixAdminRpcClient.this,
                                       ...
                                       getSessionId(),
                                       response);
                InstanceData result = FixRpcUtil.getInstanceData(response.getInstanceData());
                SLF4JLoggerProxy.trace(FixAdminRpcClient.this,
                                       "{} returning {}",
                                       getSessionId(),
                                       result);
