...
//     * @return a 
//     */
//    @Query("select distinct a.sessionId from IncomingMessage a")
//    Set<String> findDistinctSessionId();
//    /**
//     * 
//     *
//     *
...
//     * @return
//     */
//    @Query("select a from IncomingMessage a where a.sessionId=?1 and a.sendingTime >= ?2 and a.msgType in ?3 and not exists (select b.id from HandledMessage b where a.sessionId=b.sessionId and a.sendingTime=b.sendingTime and a.msgSeqNum = b.msgSeqNum)")
//    Page<PersistentIncomingMessage> findUnhandledMessage(String inSessionId,
//                                                         Date inSince,
