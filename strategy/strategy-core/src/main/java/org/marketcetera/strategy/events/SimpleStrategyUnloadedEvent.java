...
/**
 * Indicates that a strategy was unloaded.
 *
 ...
 */
@Preserve
public class SimpleStrategyUnloadedEvent
        implements StrategyUnloadedEvent
{
    /**
     * Create a new SimpleStrategyUnloadedEvent instance.
     */
    public SimpleStrategyUnloadedEvent() {}
    /**
     * Create a new SimpleStrategyUnloadedEvent instance.
     *
     * @param inStrategyInstance a <code>StrategyInstance</code> value
     */
    public SimpleStrategyUnloadedEvent(StrategyInstance inStrategyInstance)
    {
    ...
    public String toString()
    {
        ...
        builder.append("StrategyUnloadedEvent [")
