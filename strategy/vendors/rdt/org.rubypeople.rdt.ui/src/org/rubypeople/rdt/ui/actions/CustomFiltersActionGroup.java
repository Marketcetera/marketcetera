...
import org.rubypeople.rdt.internal.ui.filters.CustomFiltersDialog;
import org.rubypeople.rdt.internal.ui.filters.FilterDescriptor;
import org.rubypeople.rdt.internal.ui.filters.FilterMessages;
import org.rubypeople.rdt.internal.ui.filters.NamePatternFilter;
...
public class CustomFiltersActionGroup extends ActionGroup {
    ...
    class ShowFilterDialogAction extends Action {
        ShowFilterDialogAction() {
            ...
            setDisabledImageDescriptor(RubyPluginImages.DESC_DLCL_FILTER);
        }
    ...
    class FilterActionMenuContributionItem extends ContributionItem {
        ...
        public void fill(Menu menu, int index) {
             ...
             */
//          mi.setImage(RubyPluginImages.get(RubyPluginImages.IMG_OBJS_JAVA_WORKING_SET));
    ...
    private boolean isSelected(Object parent, Object element, IContentProvider contentProvider, ViewerFilter filter) {
        if (contentProvider instanceof ITreeContentProvider) {
            ...
            while (element != null && !(element instanceof IRubyModel)) {
    ...
    private void initializeWithPluginContributions() {
        ...
        for (int i= 0; i < filterDescs.length; i++) {
            ...
            if (fEnabledFilterIds.containsKey(id))
                RubyPlugin.logErrorMessage("WARNING: Duplicate id for extension-point \"org.eclipse.jdt.ui.javaElementFilters\""); //$NON-NLS-1$
