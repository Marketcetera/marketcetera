...
public class ReferencesSearchGroup extends ActionGroup  {
	...
	public ReferencesSearchGroup(IWorkbenchSite site) {
		...
		fFindReferencesAction.setActionDefinitionId(IRubyEditorActionDefinitionIds.SEARCH_REFERENCES_IN_WORKSPACE);
	 ...
	 */
	public ReferencesSearchGroup(RubyEditor editor) {
