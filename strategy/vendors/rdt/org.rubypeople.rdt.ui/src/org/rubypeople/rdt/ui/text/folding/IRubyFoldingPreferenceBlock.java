...
/**
 * Contributors to the <code>org.rubypeople.rdt.ui.foldingStructureProvider</code> extension point
 * can specify an implementation of this interface to be displayed on the Ruby &gt; Editor &gt; Folding
 * preference page.
 * <p>
...
public interface IRubyFoldingPreferenceBlock {
	...
	/**
	 * Creates the control that will be displayed on the Ruby &gt; Editor &gt; Folding
	 * preference page.
	 * 
