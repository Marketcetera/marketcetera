...
public class ModifyDialog extends StatusDialog {
     ...
     */
    private static final String DS_KEY_PREFERRED_WIDTH= RubyUI.ID_PLUGIN + "formatter_page.modify_dialog.preferred_width"; //$NON-NLS-1$
    private static final String DS_KEY_PREFERRED_HEIGHT= RubyUI.ID_PLUGIN + "formatter_page.modify_dialog.preferred_height"; //$NON-NLS-1$
    private static final String DS_KEY_PREFERRED_X= RubyUI.ID_PLUGIN + "formatter_page.modify_dialog.preferred_x"; //$NON-NLS-1$
    private static final String DS_KEY_PREFERRED_Y= RubyUI.ID_PLUGIN + "formatter_page.modify_dialog.preferred_y"; //$NON-NLS-1$
     ...
     * focus last time.
     */
    private static final String DS_KEY_LAST_FOCUS= RubyUI.ID_PLUGIN + "formatter_page.modify_dialog.last_focus"; //$NON-NLS-1$ 
    ...
    protected ModifyDialog(Shell parentShell, Profile profile, ProfileManager profileManager, boolean newProfile) {
        ...
        if (fProfile.isBuiltInProfile()) {
            fStandardStatus= new Status(IStatus.INFO, RubyPlugin.getPluginId(), IStatus.OK, FormatterMessages.ModifyDialog_dialog_show_warning_builtin, null); 
            fTitle= Messages.format(FormatterMessages.ModifyDialog_dialog_show_title, profile.getName()); 
        } else {
            fStandardStatus= new Status(IStatus.OK, RubyPlugin.getPluginId(), IStatus.OK, "", null); //$NON-NLS-1$
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // TODO Uncommnet the following lines as we add more preferences for the code formatter
