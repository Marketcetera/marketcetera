...
//			Rectangle textBounds= treeItem.getTextBounds(event.index);  FIXME Uncomment For 3.3+
...
//			Rectangle textBounds= tableItem.getTextBounds(event.index); FIXME Uncomment For 3.3+
