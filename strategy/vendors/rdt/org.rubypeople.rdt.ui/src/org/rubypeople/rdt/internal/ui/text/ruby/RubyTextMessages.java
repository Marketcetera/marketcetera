 ...
 */
final class RubyTextMessages extends NLS {

	private static final String BUNDLE_NAME= RubyTextMessages.class.getName();

	private RubyTextMessages() {
		// Do not instantiate
	}
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, RubyTextMessages.class);
	}
