...
public class CoreSpellingProblem extends CategorizedProblem {
	...
	public static final String MARKER_TYPE = "org.rubypeople.rdt.internal.spelling"; //$NON-NLS-1$
	...
	public String[] getArguments() {
		...
		try {
			...
			prefix = fDocument.get(line.getOffset(), fSourceStart
					- line.getOffset());
			postfix = fDocument.get(fSourceEnd + 1, line.getOffset()
					+ line.getLength() - fSourceEnd);
	 ...
	 */
	public int getID() {
		return RubySpellingReconcileStrategy.SPELLING_PROBLEM_ID;
	}
