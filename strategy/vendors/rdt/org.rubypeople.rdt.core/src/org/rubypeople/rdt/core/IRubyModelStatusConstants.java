...
/**
 * Status codes used with Ruby model status objects.
 * <p>
 ...
 */
public interface IRubyModelStatusConstants {
	...
	/**
	 * Status constant indicating that the Ruby builder
	 * could not be initialized.
	 */
	public static final int BUILDER_INITIALIZATION_ERROR = 990;

	/**
	 * Status constant indicating that the Ruby builder's last built state
	...
	/**
	 * Status indicating that a Ruby element could not be created because
	...
	/**
	 * Status indicating that a Ruby element could not be created because
	 * the project owning underlying resource does not have the Ruby nature.
	 * @see RubyCore
	 */
	 ...
	 * @see org.eclipse.jdt.core.IRubyProject#getOptions(boolean)
	 * @since 2.1
	 */
