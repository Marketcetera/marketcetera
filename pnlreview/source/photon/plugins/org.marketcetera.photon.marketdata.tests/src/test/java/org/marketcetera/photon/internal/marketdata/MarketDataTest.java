    ...
    public void before() {
        ...
        AbstractModule module = new AbstractModule() {
            ...
            protected void configure() {
                bind(ILatestTickManager.class).toInstance(mMockLatestTickManager);
                bind(ITopOfBookManager.class).toInstance(mMockTopOfBookManager);
            }
        };
        mFixture = Guice.createInjector(module).getInstance(MarketData.class);
    }
