...
/**
 * Provides a glyph for a stopped session.
 *
 * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
 * @version $Id$
 * @since $Release$
 */
public enum MarketceteraSessionStatusStoppedFont
        implements FontIcon
{
    SESSION_STATUS_STOPPED(0xe910);
    /* (non-Javadoc)
    ...
    {
        return "MetcSessionStatusStopped";
    }
    /* (non-Javadoc)
    ...
    {
        return "<span class=\"v-icon MetcSessionStatusStopped\">&#x" + Integer.toHexString(codepoint) + ";</span>";
    }
    /**
     * Create a new MarketceteraSessionStatusStoppedFont instance.
     *
     * @param inCodepoint an <code>int</code> value
     */
    private MarketceteraSessionStatusStoppedFont(int inCodepoint)
    {
