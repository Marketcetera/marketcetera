...
public class OptionTest extends InstrumentTestBase<Option> {
    ...
    protected Option createFixture() {
        return new Option("ABC", "20091010", BigDecimal.ONE,
                OptionType.Call);
    }
    ...
    protected List<Option> createDifferentFixtures() {
        return ImmutableList.<Option> of(
                ...
                new Option("ABC", "20091010", new BigDecimal("5"),
                        OptionType.Call),

                new Option("ABC", "20091010", new BigDecimal("6"),
                        OptionType.Call),

                new Option("ABC", "20091011", new BigDecimal("5"),
                        OptionType.Call),

                new Option("ABC", "20091010", new BigDecimal("5"),
                        OptionType.Put),

                new Option("METC", "20091011", new BigDecimal("5"),
                        OptionType.Call));
    }

    @Test
    public void testStrikePriceTrailingZerosTrimmed()
            throws Exception {
    ...
    public void testNullSymbol() throws Exception {
        new ExpectedFailure<IllegalArgumentException>(null) {
            ...
            protected void run() throws Exception {
                new Option(null, "20091010", BigDecimal.ONE,
                        OptionType.Call);
            }
        };
    }
