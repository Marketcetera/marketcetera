...
public interface Messages
{
    ...
    static final I18NMessage0P VALIDATION_NULL_UNDERLYING_EQUITY = new I18NMessage0P(LOGGER,
                                                                                     "validation_null_underlying_equity"); //$NON-NLS-1$
    static final I18NMessage0P VALIDATION_NULL_EXPIRY = new I18NMessage0P(LOGGER,
                                                                         "validation_null_expiry"); //$NON-NLS-1$
    static final I18NMessage0P VALIDATION_NULL_STRIKE = new I18NMessage0P(LOGGER,
                                                                          "validation_null_strike"); //$NON-NLS-1$
    static final I18NMessage0P VALIDATION_NULL_OPTION_TYPE = new I18NMessage0P(LOGGER,
                                                                               "validation_null_option_type"); //$NON-NLS-1$
