...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HIBERNATE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 100 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" 
   (    "supervisor_permission_id" NUMBER(19,0), 
    "PERMISSIONS_ID" NUMBER(19,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
Insert into SUPERVISOR_PERMISSIONS_PERMISSIONS (supervisor_permission_id,PERMISSIONS_ID) values (43,29);
Insert into SUPERVISOR_PERMISSIONS_PERMISSIONS (supervisor_permission_id,PERMISSIONS_ID) values (43,30);
Insert into SUPERVISOR_PERMISSIONS_PERMISSIONS (supervisor_permission_id,PERMISSIONS_ID) values (43,31);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUPERVISOR_PERMISSIONS_USERS" MODIFY ("supervisor_permission_id" NOT NULL ENABLE);
  ALTER TABLE "SUPERVISOR_PERMISSIONS_USERS" MODIFY ("SUBJECTS_ID" NOT NULL ENABLE);
  ALTER TABLE "SUPERVISOR_PERMISSIONS_USERS" ADD PRIMARY KEY ("supervisor_permission_id", "SUBJECTS_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" MODIFY ("supervisor_permission_id" NOT NULL ENABLE);
  ALTER TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" MODIFY ("PERMISSIONS_ID" NOT NULL ENABLE);
  ALTER TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" ADD PRIMARY KEY ("supervisor_permission_id", "PERMISSIONS_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" ADD CONSTRAINT "FKTKCTB5N3GGMU727F5MWLMUTK3" FOREIGN KEY ("PERMISSIONS_ID")
      REFERENCES "PERMISSIONS" ("ID") ENABLE;
  ALTER TABLE "SUPERVISOR_PERMISSIONS_PERMISSIONS" ADD CONSTRAINT "FK6B5T61SOYNLXLYRMB8Y59Y6TF" FOREIGN KEY ("supervisor_permission_id")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUPERVISOR_PERMISSIONS_USERS" ADD CONSTRAINT "FKL8HK9CJ6MAVQ8OQVUN76XL3AG" FOREIGN KEY ("SUBJECTS_ID")
      REFERENCES "USERS" ("ID") ENABLE;
  ALTER TABLE "SUPERVISOR_PERMISSIONS_USERS" ADD CONSTRAINT "FK16N73Q253VU1UNEMUPOBM3EKJ" FOREIGN KEY ("supervisor_permission_id")
      REFERENCES "SUPERVISOR_PERMISSIONS" ("ID") ENABLE;
--------------------------------------------------------
