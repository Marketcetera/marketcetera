...
/* $License$ */
/**
 * Currency Order Sender Strategy
 *
 */
public class CurrencyOrderSender extends Strategy {
    private static final String SYMBOLS = "GBP/USD"; // Depends on MD - can be other symbols
    ...
    public void onStart() {
        mRequestID = requestMarketData(MarketDataRequestBuilder.newRequest().
                ...
                withAssetClass(AssetClass.CURRENCY).create());
    ...
    public void onBid(BidEvent inBid) {
        ...
        order.setBrokerID(new BrokerID("metc"));
