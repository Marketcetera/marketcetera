...
import org.marketcetera.core.except.ExceptUtils;
import org.marketcetera.core.misc.ClassVersion;
import org.marketcetera.matp.Application;
...
//        MessageManager.addMessageProvider(getProviderId(),provider);
                          ...
                          Object... params)
    {
        ...
        try {
            return Application.getInstance().getApplicationContext().getMessage(messageId,
                                                                                params,
                                                                                locale);
        } catch (Exception ex) {
            ...
            if (ex instanceof NoSuchMessageException) {
