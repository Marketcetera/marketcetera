 ...
 *
 * @version $Id: Messages.java 16325 2012-10-25 23:13:12Z colin $
 * @since 0.6.0
 */
public interface Messages
{
    static final I18NMessageProvider PROVIDER = new I18NMessageProvider("bogus_neo", Messages.class.getClassLoader());  //$NON-NLS-1$
    ...
    public static final I18NMessage1P UNRESOLVABLE_SYMBOL = new I18NMessage1P(LOGGER,"unresolvable_symbol"); //$NON-NLS-1$
}
