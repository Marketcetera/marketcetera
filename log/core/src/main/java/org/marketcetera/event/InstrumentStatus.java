...
public enum InstrumentStatus
{
    ...
    /**
     * Gets the <code>InstrumentStatus</code> for the given code.
     *
     * @param inCode an <code>int</code> value
     * @return an <code>InstrumentStatus</code> value
     * @throws IllegalArgumentException if the code does not correspond to an <code>InstrumentStatus</code>
     */
    public static InstrumentStatus getFor(int inCode)
    {
        InstrumentStatus type = typesByCode.get(inCode);
        if(type == null) {
    ...
    /**
     * Create a new InstrumentStatus instance.
     *
     * @param inCode an <code>int</code> value
     */
    private InstrumentStatus(int inCode)
    {
        code = inCode;
    }
    /**
     ...
     */
    private static final Map<Integer,InstrumentStatus> typesByCode = Maps.newHashMap();
    /**
