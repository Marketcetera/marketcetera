#!/bin/bash
# Script to update JMSSerMessageConverter to use Jakarta JMS

cat > /tmp/JMSSerMessageConverter.java <<'EOF'
...
mv /tmp/JMSSerMessageConverter.java /Users/colin/marketcetera/workspaces/sixer-java11/code/marketcetera/core/src/main/java/org/marketcetera/jms/JMSSerMessageConverter.java

echo "JMSSerMessageConverter updated to use Jakarta JMS"