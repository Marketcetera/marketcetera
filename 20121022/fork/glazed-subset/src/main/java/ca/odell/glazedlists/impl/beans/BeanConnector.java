...
public class BeanConnector<E> implements ObservableElementList.Connector<E> {
    ...
    /** The list which contains the elements being observed via this {@link ca.odell.glazedlists.ObservableElementList.Connector}. */
     ...
     * characters.
     *
     * @param beanClass the Class of all list elements within the {@link ca.odell.glazedlists.ObservableElementList}
     ...
     *      to the elements within the {@link ca.odell.glazedlists.ObservableElementList}
     * @param removeListenerMethodName the name of the method which removes PropertyChangeListeners
     *      from the elements within the {@link ca.odell.glazedlists.ObservableElementList}
     ...
     *        elements within the {@link ca.odell.glazedlists.ObservableElementList}
     * @param removeListenerMethodName the name of the method which removes PropertyChangeListeners
     *        from the elements within the {@link ca.odell.glazedlists.ObservableElementList}
     * @param eventMatcher the matcher for matching those PropertyChangeEvents, which should be
     *        delivered to the ObservableElementList
    ...
    /**
     * The PropertyChangeListener which notifies the {@link ca.odell.glazedlists.ObservableElementList} within this
