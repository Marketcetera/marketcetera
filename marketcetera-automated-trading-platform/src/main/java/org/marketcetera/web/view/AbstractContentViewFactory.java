...
{
    /* (non-Javadoc)
     * @see org.marketcetera.web.view.ContentViewFactory#create(com.vaadin.ui.Dialog, org.marketcetera.web.events.NewDialogEvent, java.util.Properties)
     */
    @Override
    public ContentView create(Dialog inParent,
