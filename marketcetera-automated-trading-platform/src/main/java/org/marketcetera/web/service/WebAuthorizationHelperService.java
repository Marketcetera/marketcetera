        ...
        implements AuthorizationHelperService
{
    ...
    {
        User sessionUser = AuthenticatedUser.getCurrentUser();
        if(sessionUser == null) {
        ...
        return permissionMapsByUsername.getUnchecked(sessionUser.getName()).getUnchecked(inGrantedAuthority.getAuthority());
    }
    /**
